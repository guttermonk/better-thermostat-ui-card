 ...
 */,Vp={},Up=xe(class extends ze{constructor(){super(...arguments),this.ot=Vp}render(e,t){return t()}update(e,[t,o]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((e,t)=>e===this.ot[t])))return Y}else if(this.ot===t)return Y;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,o)}});let Fp;const Gp={icon:{}},Kp={boolean:{}};let Zp=class extends me{constructor(){super(...arguments),this.presets=[],this._attached=!1,this._renderEmptySortable=!1}connectedCallback(){super.connectedCallback(),this._attached=!0}disconnectedCallback(){super.disconnectedCallback(),this._attached=!1}render(){return this.hass?q`
    ...
    `}_presetsChanged(e){if(e.stopPropagation(),!this._config)return;const t={...this._config},o=Ip(e.detail.options);o?t.preset_options=o:delete t.preset_options;const i=Op(this._presetModesString);e.detail.order.join(" ")!==i.join(" ")?t.preset_order=e.detail.order:delete t.preset_order,this._config=t,Se(this,"config-changed",{config:t})}_valueChanged(e){const t={...e.detail.value};if(void 0!==t.show_mode_buttons&&delete t.disable_all_buttons,t.colors){const e=Object.fromEntries(Object.entries(t.colors).filter((([,e])=>e)));0===Object.keys(e).length?delete t.colors:t.colors=e}Se(this,"config-changed",{config:t})}};n([ye()],Xp.prototype,"_config",void 0),Xp=n([ge(fc)],Xp);var Yp=Object.freeze({__proto__:null,get ClimateCardEditor(){return Xp}});const Jp=gt(((e,t,o,i,n)=>[{name:"entity",selector:{entity:{domain:tp}}},{name:"name",selector:{text:{}}},...e?[]:[Dp()],Hp([{name:"show_current_as_primary"},{name:"show_secondary"},{name:"disable_humidity"}]),Np(t,o,i,n)])),Qp=gt((e=>[Lp([{name:"show_mode_buttons"},{name:"disable_buttons"},{name:"disable_presets"},{name:"show_all_presets"},{name:"disable_menu"},{name:"prevent_interaction_on_scroll"}]),...e?[Rp()]:[]]));let em=class extends lc{static get styles(){const e=super.styles;return[...Array.isArray(e)?e:e?[e]:[],h`
      ...
      `]}connectedCallback(){super.connectedCallback(),Pp()}setConfig(e){this._config=e}get _stateObj(){return this._config?.entity?this.hass?.states[this._config.entity]:void 0}get _presetModesString(){const e=this._config?.preset_entity?this.hass?.states[this._config.preset_entity]:void 0;if(e)return(e.attributes.options??[]).join(",");const t=this._stateObj;return t?(t.attributes.preset_modes??[]).join(","):void 0}render(){if(!this.hass)return q``;const e=$h(this.hass),t=this._stateObj,o=!t||qc(t),i=this._presetModesString,n=Jp(o,t?(t.attributes.hvac_modes??[]).join(","):void 0,i,e("editor.card.climate.color_source_preset"),e("editor.card.climate.color_source_hvac")),r=Qp(o),a=Uc(Op(i),this._config?.preset_order),s={...this._config,low_battery_threshold:this._config?.low_battery_threshold??10,show_secondary:this._config?.show_secondary??!0,disable_buttons:this._config?.disable_buttons??!0,show_mode_buttons:!this._config||Tt(this._config)},l=o=>{if("entity"===o.name)return e("ui.panel.lovelace.editor.card.generic.entity")||o.name;if("colors"===o.name)return e("editor.card.climate.section_colors")||o.name;const i=Bp(this.hass,t,o.name,e);return void 0!==i?i:Tp.includes(o.name)?e(`editor.card.generic.${o.name}`)||o.name:e(`editor.card.climate.${o.name}`)||o.name},c=t=>"colors"===t.name?e("editor.card.climate.section_colors_helper"):void 0;return q`
      ${o?"":q`
            <ha-alert alert-type="info">
