...
`,$c={none:"mdi:auto-mode",auto:"mdi:thermostat-auto",cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",heat:"mdi:fire",heat_cool:"mdi:sun-snowflake-variant",off:"mdi:power",eco:"mdi:leaf",away:"mdi:account-arrow-right",boost:"mdi:rocket-launch",sleep:"mdi:bed",comfort:"mdi:sofa",activity:"mdi:motion-sensor",home:"mdi:home"},Sc={cooling:"mdi:snowflake",drying:"mdi:water-percent",heating:"mdi:fire",idle:"mdi:clock-outline",off:"mdi:power"};function Tc(e){return $c[e]??"mdi:thermostat"}function jc(e){return $c[e.toLowerCase()]??"mdi:tune-variant"}let Pc=class extends _e{constructor(){super(...arguments),this.fill=!1,this.disableEco=!1}callService(e){e.stopPropagation();const t=e.currentTarget.mode;this.hass.callService("climate","set_hvac_mode",{entity_id:this.entity.entity_id,hvac_mode:t})}toggleEco(e){e.stopPropagation();const t=this.entity.attributes.preset_mode,o=this.entity.attributes.preset_modes?.includes("eco"),i="eco"===t||!0===this.entity.attributes.eco_mode;if(o){const e=i?"none":"eco";this.hass.callService("climate","set_preset_mode",{entity_id:this.entity.entity_id,preset_mode:e})}else this.hass.callService("better_thermostat","set_eco_mode",{entity_id:this.entity.entity_id,enable:!i})}renderEcoButton(){const e={};return!0===this.entity.attributes.eco_mode&&(e["--icon-color"]="var(--bt-color-eco)",e["--bg-color"]=bc("var(--bt-color-eco)",.2)),W`
    ...
    `}async firstUpdated(e){super.firstUpdated(e),await Promise.all([Mt("mushroom-button",(()=>Promise.resolve().then((function(){return fp})))),Mt("mushroom-button-group",(()=>Promise.resolve().then((function(){return yp})))),Mt("mushroom-input-number",(()=>Promise.resolve().then((function(){return kp}))))])}};function Fc(e){return void 0!==e?.attributes?.call_for_heat}function Gc(e){const t=Object.keys(e.states).filter((e=>"climate"===e.split(".")[0]));return t.find((t=>Fc(e.states[t])))??t[0]}n([ve({attribute:!1})],Uc.prototype,"hass",void 0),n([ve({attribute:!1})],Uc.prototype,"entity",void 0),n([ve()],Uc.prototype,"fill",void 0),Uc=n([ge("mushroom-climate-temperature-control")],Uc);const Kc=["on","open","true"];function Zc(e,t,o){if(Fc(t)){const e=t.attributes?.window_open;return!0===e||"string"==typeof e&&Kc.includes(e.toLowerCase())}const i=o?.window_sensor;if(!i)return!1;const n=e?.states?.[i];return!!n&&Kc.includes(String(n.state).toLowerCase())}function qc(e,t,o){if(e&&!o?.disable_humidity){if(null!=t?.attributes?.current_humidity){const o=Number(t.attributes.current_humidity);return e.formatEntityAttributeValue(t,"current_humidity",Number.isFinite(o)?Math.round(o):void 0)}if(!Fc(t)&&o?.humidity_sensor){const t=e.states?.[o.humidity_sensor];if(t&&!isNaN(Number(t.state)))return e.formatEntityState(t)}}}const Wc=mt((function(e,t){if(void 0!==e)try{const o=Object.entries(JSON.parse(e));return o.map((([e,o])=>({name:e,battery:"on"===o.battery?t-1:"off"===o.battery?100:parseFloat(o.battery)}))).find((e=>e.battery<t))}catch(e){return}})),Xc=mt((function(e){if(void 0!==e)try{const t=JSON.parse(e);if(!Array.isArray(t)||0===t.length)return;const o=t[0];return"string"==typeof o?o:"object"==typeof o&&null!==o?o.entity_id||o.entity||o.name:void 0}catch(e){return}}));function Yc(e,t){return t?.debug_battery?{name:"Debug Battery",battery:5}:t?.disable_battery_warning?void 0:Wc(e.attributes?.batteries,t?.low_battery_threshold??10)}function Jc(e,t){return t?.debug_connection?"Debug Connection":t?.disable_connection_lost_warning?void 0:Xc(e.attributes?.errors)}function Qc(e,t){return!!t?.debug_degraded||!t?.disable_degraded_warning&&!0===e.attributes?.degraded_mode}var eu={version:"version",current:"current",current_humidity:"Current humidity",current_temperature:"Current temperature",target_temperature:"Target temperature"},tu={card:{climate:{disable_humidity:"Turn off the humidity display",disable_eco:"Turn off the eco button",disable_presets:"Turn off the presets button",show_all_presets:"Show all presets as buttons",disable_menu:"Disable menu",disable_battery_warning:"Turn off the battery warning",disable_buttons:"Turn off the plus/minus buttons",disable_all_buttons:"Turn off all buttons",show_temperature_control:"Show temperature control",collapsible_controls:"Collapsible controls",show_current_as_primary:"Show current temperature as primary",show_secondary:"Show secondary information",prevent_interaction_on_scroll:"Prevent interaction on scroll",disable_connection_lost_warning:"Turn off the connection lost warning",disable_degraded_warning:"Turn off the degraded mode warning",debug_battery:"Debug: Show battery warning",debug_connection:"Debug: Show connection lost warning",debug_degraded:"Debug: Show degraded mode warning",low_battery_threshold:"Low battery warning threshold (%)",section_display:"Display",section_colors:"Colors",section_colors_helper:"Override the colors used for HVAC modes and presets. Pick a theme color, or clear a picker to restore the default.",section_interaction:"Interaction",section_features:"Features",section_warnings:"Warnings",section_sensors:"External sensors",window_sensor:"Window sensor",humidity_sensor:"Humidity sensor",preset_entity:"Preset select entity",not_bt_info:"The selected entity is not a Better Thermostat entity. The card still works with it, but to show the window open and humidity states you need to select the matching sensors in the 'External sensors' section."}}},ou={presets:"Presets",window_open:"Window open",eco:"Eco",summer:"Summer",cooling:"Cooling",heating:"Heating",cooling_off:"Cooling off",heating_off:"Heating off",degraded_mode:"Degraded mode",connection_lost:"Connection lost: {name}",low_battery:"Low battery: {name}",window_closed:"Window closed"},iu={common:eu,editor:tu,extra_states:ou},nu=Object.freeze({__proto__:null,common:eu,default:iu,editor:tu,extra_states:ou}),ru={version:"Version",current:"Aktuell",current_humidity:"Aktuelle Luftfeuchtigkeit",current_temperature:"Aktuelle Temperatur",target_temperature:"Zieltemperatur"},au={card:{climate:{disable_eco:"Eco-Anzeige deaktivieren",disable_presets:"Presets-Button deaktivieren",disable_menu:"Menü deaktivieren",disable_battery_warning:"Batterie-Warnung deaktivieren",disable_buttons:"Plus/Minus Buttons deaktivieren",disable_all_buttons:"Alle Buttons deaktivieren",show_current_as_primary:"Aktuelle Temperatur als primär anzeigen",show_secondary:"Sekundäre Informationen anzeigen",prevent_interaction_on_scroll:"Interaktion beim Scrollen verhindern",disable_humidity:"Deaktiviere die Anzeige der Luftfeuchtigkeit",show_temperature_control:"Temperaturregelung anzeigen",collapsible_controls:"Einklappbare Steuerung",disable_connection_lost_warning:"Verbindungsverlust-Warnung deaktivieren",disable_degraded_warning:"Warnung für eingeschränkten Modus deaktivieren",debug_battery:"Debug: Batterie-Warnung anzeigen",debug_connection:"Debug: Verbindungsverlust-Warnung anzeigen",debug_degraded:"Debug: Warnung für eingeschränkten Modus anzeigen",low_battery_threshold:"Schwellenwert Batteriewarnung (%)",section_display:"Anzeige",section_interaction:"Interaktion",section_features:"Funktionen",section_warnings:"Warnungen",section_sensors:"Externe Sensoren",window_sensor:"Fenstersensor",humidity_sensor:"Luftfeuchtigkeitssensor",not_bt_info:"Die ausgewählte Entität ist keine Better Thermostat Entität. Die Karte funktioniert trotzdem, aber für die Fenster-offen- und Luftfeuchtigkeitsanzeige müssen die passenden Sensoren im Abschnitt 'Externe Sensoren' ausgewählt werden."}}},su={window_open:"Fenster offen",eco:"Eco",summer:"Sommer",cooling:"Kühlen",heating:"Heizen",cooling_off:"Kühlung aus",heating_off:"Heizung aus",degraded_mode:"Eingeschränkter Modus",connection_lost:"Verbindung verloren: {name}",low_battery:"Batterie schwach: {name}",window_closed:"Fenster geschlossen"},lu={common:ru,editor:au,extra_states:su},cu=Object.freeze({__proto__:null,common:ru,default:lu,editor:au,extra_states:su}),uu={version:"Version",current:"Actuel",current_humidity:"Humidité actuelle",current_temperature:"Température actuelle",target_temperature:"Température cible"},du={card:{climate:{disable_eco:"Désactiver mode Éco",disable_menu:"Désactiver le menu",disable_battery_warning:"Désactiver l'avertissement de batterie",disable_buttons:"Désactiver les boutons plus/moins",show_current_as_primary:"Afficher la température actuelle comme principale",show_secondary:"Afficher les informations secondaires",prevent_interaction_on_scroll:"Empêcher l'interaction lors du défilement",disable_humidity:"Désactiver l'affichage de l'humidité",show_temperature_control:"Afficher le contrôle de température",collapsible_controls:"Contrôles pliables",disable_connection_lost_warning:"Désactiver avertissement perte de connexion",disable_degraded_warning:"Désactiver avertissement mode dégradé",low_battery_threshold:"Seuil avertissement batterie faible (%)",section_display:"Affichage",section_interaction:"Interaction",section_features:"Fonctionnalités",section_warnings:"Avertissements"}}},hu={window_open:"Fenêtre ouverte",eco:"Éco",summer:"Été",cooling:"Refroidissement",heating:"Chauffage",cooling_off:"Refroidissement éteint",heating_off:"Chauffage éteint",window_closed:"Fenêtre fermée"},pu={common:uu,editor:du,extra_states:hu},_u=Object.freeze({__proto__:null,common:uu,default:pu,editor:du,extra_states:hu}),mu={version:"версия",current:"текущая версия",current_humidity:"Текущая влажность",current_temperature:"Текущая температура",target_temperature:"Целевая температура"},gu={card:{climate:{disable_eco:"Отключить режим eco",disable_menu:"Отключить меню",disable_battery_warning:"Отключить предупреждение о разряде батареи",disable_buttons:"Отключить кнопку плюс/минус",show_current_as_primary:"Показывать текущую температуру как основную",show_secondary:"Показывать вторичную информацию",prevent_interaction_on_scroll:"Предотвратить взаимодействие при прокрутке",disable_humidity:"Отключить отображение влажности",show_temperature_control:"Показать управление температурой",collapsible_controls:"Сворачиваемые элементы управления",disable_connection_lost_warning:"Отключить предупреждение о потере соединения",disable_degraded_warning:"Отключить предупреждение о деградированном режиме",low_battery_threshold:"Порог предупреждения о низком заряде (%)",section_display:"Отображение",section_interaction:"Взаимодействие",section_features:"Функции",section_warnings:"Предупреждения"}}},bu={window_open:"Окно открыто",eco:"Эко",summer:"Летний режим",cooling:"Охлаждение",heating:"Обогрев",cooling_off:"Охлаждение выключено",heating_off:"Обогрев выключен",window_closed:"Окно закрыто"},fu={common:mu,editor:gu,extra_states:bu},vu=Object.freeze({__proto__:null,common:mu,default:fu,editor:gu,extra_states:bu}),yu={version:"Wersja",current:"Aktualna",current_humidity:"Aktualna wilgotność",current_temperature:"Aktualna temperatura",target_temperature:"Temperatura docelowa"},wu={card:{climate:{disable_eco:"Wyłącz przycisk trybu eko",disable_menu:"Wyłącz menu",disable_battery_warning:"Wyłącz ostrzeżenie o baterii",disable_buttons:"Wyłącz przyciski plus/minus",show_current_as_primary:"Pokaż aktualną temperaturę jako główną",show_secondary:"Pokaż dodatkowe informacje",prevent_interaction_on_scroll:"Zapobiegaj interakcji podczas przewijania",disable_humidity:"Wyłącz wyświetlanie wilgotności",show_temperature_control:"Pokaż suwak temperatury",collapsible_controls:"Rozwijane menu ustawień",disable_connection_lost_warning:"Wyłącz ostrzeżenie o utracie połączenia",disable_degraded_warning:"Wyłącz ostrzeżenie o trybie ograniczonym",low_battery_threshold:"Próg ostrzeżenia o niskim stanie baterii (%)",section_display:"Wyświetlanie",section_interaction:"Interakcja",section_features:"Funkcje",section_warnings:"Ostrzeżenia",disable_presets:"Wyłącz przyciski ustawień predefiniowanych",disable_all_buttons:"Wyłącz wszystkie przyciski",debug_battery:"Debug: Pokaż ostrzeżenie baterii",debug_connection:"Debug: Pokaż ostrzeżenie o utracie połączenia",debug_degraded:"Debug: Pokaż ostrzeżenie o trybie ograniczonym",section_sensors:"Czujniki zewnętrzne",window_sensor:"Czujnik otwarcia okna",humidity_sensor:"Czujnik wilgotności",not_bt_info:"Wybrana encja nie jest encją Better Thermostat. Karta nadal z nią współpracuje, ale aby wyświetlić stany otwarcia okna i wilgotności, należy wybrać pasujące czujniki w sekcji „Czujniki zewnętrzne”."}}},ku={window_open:"Otwarte okno",eco:"Tryb eko",summer:"Lato",cooling:"Chłodzenie",heating:"Grzanie",cooling_off:"Chłodzenie wyłączone",heating_off:"Grzanie wyłączone",window_closed:"Okno zamknięte",degraded_mode:"Tryb ograniczony",connection_lost:"Połączenie utracone: {name}",low_battery:"Niski poziom baterii: {name}"},zu={common:yu,editor:wu,extra_states:ku},xu=Object.freeze({__proto__:null,common:yu,default:zu,editor:wu,extra_states:ku}),Au={version:"verzia",current:"aktuálny",current_humidity:"Aktuálna vlhkosť",current_temperature:"Aktuálna teplota",target_temperature:"Cieľová teplota"},Eu={card:{climate:{disable_eco:"Zakázať eco",disable_menu:"Zakázať menu",disable_battery_warning:"Zakázať upozornenie na batériu",disable_buttons:"Zakázať plus/mínus tlačidlá",show_current_as_primary:"Zobraziť aktuálnu teplotu ako hlavnú",show_secondary:"Zobraziť sekundárne informácie",prevent_interaction_on_scroll:"Zabrániť interakcii pri posúvaní",disable_humidity:"Vypnúť zobrazenie vlhkosti",show_temperature_control:"Zobraziť ovládanie teploty",collapsible_controls:"Skladateľné ovládanie",disable_connection_lost_warning:"Vypnúť upozornenie na stratu spojenia",disable_degraded_warning:"Vypnúť upozornenie na zhoršený režim",low_battery_threshold:"Prah varovania o nízkej batérii (%)",section_display:"Zobrazenie",section_interaction:"Interakcia",section_features:"Funkcie",section_warnings:"Upozornenia"}}},Cu={window_open:"Okno otvorené",eco:"Eco",summer:"Leto",cooling:"Chladenie",heating:"Kúrenie",cooling_off:"Chladenie vypnuté",heating_off:"Kúrenie vypnuté",window_closed:"Okno zatvorené"},Mu={common:Au,editor:Eu,extra_states:Cu},$u={version:"verzija",current:"trenutno",current_humidity:"Trenutna vlažnost",current_temperature:"Trenutna temperatura",target_temperature:"Ciljana temperatura"},Su={card:{climate:{disable_eco:"Isključi prikaz eco gumba",disable_menu:"Isključi prikaz izbornika",disable_battery_warning:"Isključi upozorenje baterije",disable_buttons:"Isključi prikaz plus/minus gumbi",show_current_as_primary:"Prikaži trenutnu temperaturu kao primarnu",show_secondary:"Prikaži sekundarne informacije",prevent_interaction_on_scroll:"Spriječi interakciju pri pomicanju",disable_humidity:"Isključi prikaz vlažnosti",show_temperature_control:"Prikaži kontrolu temperature",collapsible_controls:"Sklopive kontrole",disable_connection_lost_warning:"Isključi upozorenje o gubitku veze",disable_degraded_warning:"Isključi upozorenje o degradiranom načinu",low_battery_threshold:"Prag upozorenja za nisku bateriju (%)",section_display:"Prikaz",section_interaction:"Interakcija",section_features:"Značajke",section_warnings:"Upozorenja"}}},Tu={window_open:"Prozor otvoren",window_closed:"Prozor zatvoren",eco:"Eco",summer:"Ljeto",cooling:"Hlađenje",heating:"Grijanje",cooling_off:"Hlađenje isključeno",heating_off:"Grijanje isključeno"},ju={common:$u,editor:Su,extra_states:Tu},Pu={version:"Verzió",current:"Aktuális",current_humidity:"Jelenlegi páratartalom",current_temperature:"Jelenlegi hőmérséklet",target_temperature:"Célhőmérséklet"},Hu={card:{climate:{disable_eco:"Eco kikapcsolás",disable_menu:"Menü letiltása",disable_battery_warning:"Akkumulátor figyelmeztetés letiltása",disable_buttons:"Plusz/mínusz gombok letiltása",show_current_as_primary:"Jelenlegi hőmérséklet megjelenítése elsődlegesként",show_secondary:"Másodlagos információk megjelenítése",prevent_interaction_on_scroll:"Interakció megakadályozása görgetéskor",disable_humidity:"Páratartalom megjelenítés kikapcsolása",show_temperature_control:"Hőmérséklet-szabályzó megjelenítése",collapsible_controls:"Összecsukható vezérlők",disable_connection_lost_warning:"Kapcsolatvesztés figyelmeztetés kikapcsolása",disable_degraded_warning:"Korlátozott mód figyelmeztetés kikapcsolása",low_battery_threshold:"Alacsony akkumulátor figyelmeztetési küszöb (%)",section_display:"Megjelenítés",section_interaction:"Interakció",section_features:"Funkciók",section_warnings:"Figyelmeztetések"}}},Ou={window_open:"Ablak nyitva",eco:"Eco",summer:"Nyár",cooling:"Hűtés",heating:"Fűtés",cooling_off:"Hűtés kikapcsolva",heating_off:"Fűtés kikapcsolva",window_closed:"Ablak zárva"},Iu={common:Pu,editor:Hu,extra_states:Ou},Bu={version:"Version",current:"Nuværende",current_humidity:"Nuværende fugtighed",current_temperature:"Nuværende temperatur",target_temperature:"Målt temperatur"},Nu={card:{climate:{disable_eco:"Deaktiver Eco indikator",disable_menu:"Deaktiver menu",disable_battery_warning:"Deaktiver batteriadvarsel",disable_buttons:"Deaktiver plus/minus knapper",show_current_as_primary:"Vis nuværende temperatur som primær",show_secondary:"Vis sekundær information",prevent_interaction_on_scroll:"Forhindre interaktion ved scrolling",disable_humidity:"Deaktiver fugtighedsvisning",show_temperature_control:"Vis temperaturkontrol",collapsible_controls:"Sammenklappelige kontroller",disable_connection_lost_warning:"Deaktiver advarsel om mistet forbindelse",disable_degraded_warning:"Deaktiver advarsel om forringet tilstand",low_battery_threshold:"Grænse for advarsel om lavt batteri (%)",section_display:"Visning",section_interaction:"Interaktion",section_features:"Funktioner",section_warnings:"Advarsler"}}},Lu={window_open:"Vindue åbent",eco:"Eco",summer:"Sommer",cooling:"Køling",heating:"Opvarmning",cooling_off:"Køling slukket",heating_off:"Opvarmning slukket",window_closed:"Vindue lukket"},Du={common:Bu,editor:Nu,extra_states:Lu},Vu={version:"Versión",current:"Actual",current_humidity:"Humedad actual",current_temperature:"Temperatura actual",target_temperature:"Temperatura objetivo"},Ru={card:{climate:{disable_eco:"Deshabilitar eco",disable_menu:"Deshabilitar menú",disable_battery_warning:"Deshabilitar alerta de batería",disable_buttons:"Deshabilitar botones más/menos",show_current_as_primary:"Mostrar temperatura actual como principal",show_secondary:"Mostrar información secundaria",prevent_interaction_on_scroll:"Evitar interacción al desplazarse",disable_humidity:"Desactivar la visualización de humedad",show_temperature_control:"Mostrar control de temperatura",collapsible_controls:"Controles plegables",disable_connection_lost_warning:"Desactivar aviso de pérdida de conexión",disable_degraded_warning:"Desactivar aviso de modo degradado",low_battery_threshold:"Umbral de aviso de batería baja (%)",section_display:"Pantalla",section_interaction:"Interacción",section_features:"Funciones",section_warnings:"Advertencias"}}},Uu={window_open:"Ventana abierta",eco:"Eco",summer:"Verano",cooling:"Enfriamiento",heating:"Calefacción",cooling_off:"Enfriamiento apagado",heating_off:"Calefacción apagada",window_closed:"Ventana cerrada"},Fu={common:Vu,editor:Ru,extra_states:Uu},Gu={version:"versiyon",current:"şimdiki",current_humidity:"Mevcut Nem",current_temperature:"Mevcut Sıcaklık",target_temperature:"Hedef Sıcaklık"},Ku={card:{climate:{disable_eco:"Eco'yu devre dışı bırak",disable_menu:"Menüyü devre dışı bırak",disable_battery_warning:"Pil uyarısını devre dışı bırak",disable_buttons:"Artı/eksi düğmelerini devre dışı bırak",show_current_as_primary:"Mevcut sıcaklığı birincil olarak göster",show_secondary:"İkincil bilgileri göster",prevent_interaction_on_scroll:"Kaydırma sırasında etkileşimi önle",disable_humidity:"Nem gösterimini kapat",show_temperature_control:"Sıcaklık kontrolünü göster",collapsible_controls:"Daraltılabilir kontroller",disable_connection_lost_warning:"Bağlantı kesildi uyarısını kapat",disable_degraded_warning:"Düşük mod uyarısını kapat",low_battery_threshold:"Düşük pil uyarı eşiği (%)",section_display:"Görünüm",section_interaction:"Etkileşim",section_features:"Özellikler",section_warnings:"Uyarılar"}}},Zu={window_open:"Pencere açık",eco:"Eco",summer:"Yaz",cooling:"Soğutma",heating:"Isıtma",cooling_off:"Soğutma kapalı",heating_off:"Isıtma kapalı",window_closed:"Pencere kapalı"},qu={common:Gu,editor:Ku,extra_states:Zu},Wu={version:"versione",current:"Corrente",current_humidity:"Umidità attuale",current_temperature:"Temperatura attuale",target_temperature:"Temperatura obiettivo"},Xu={card:{climate:{disable_eco:"Disabilita tasto eco",disable_menu:"Disabilita menu",disable_battery_warning:"Disabilita avviso batteria",disable_buttons:"Disabilita pulsanti più/meno",show_current_as_primary:"Mostra temperatura attuale come principale",show_secondary:"Mostra informazioni secondarie",prevent_interaction_on_scroll:"Prevenire interazione durante lo scorrimento",disable_humidity:"Disattiva visualizzazione umidità",show_temperature_control:"Mostra controllo temperatura",collapsible_controls:"Controlli comprimibili",disable_connection_lost_warning:"Disabilita avviso perdita connessione",disable_degraded_warning:"Disabilita avviso modalità degradata",low_battery_threshold:"Soglia avviso batteria scarica (%)",section_display:"Schermo",section_interaction:"Interazione",section_features:"Funzionalità",section_warnings:"Avvisi"}}},Yu={window_open:"Finestra aperta",eco:"Eco",summer:"Estate",cooling:"Raffreddamento",heating:"Riscaldamento",cooling_off:"Raffreddamento spento",heating_off:"Riscaldamento spento",window_closed:"Finestra chiusa"},Ju={common:Wu,editor:Xu,extra_states:Yu},Qu={version:"Versão",current:"Atual",current_humidity:"Humidade atual",current_temperature:"Temperatura atual",target_temperature:"Temperatura alvo"},ed={card:{climate:{disable_eco:"Desactivar Eco",disable_menu:"Desativar menu",disable_battery_warning:"Desativar aviso de bateria",disable_buttons:"Desativar botões de mais/menos",show_current_as_primary:"Mostrar temperatura atual como principal",show_secondary:"Mostrar informações secundárias",prevent_interaction_on_scroll:"Prevenir interação ao rolar",disable_humidity:"Desativar exibição de humidade",show_temperature_control:"Mostrar controlo de temperatura",collapsible_controls:"Controlos recolhíveis",disable_connection_lost_warning:"Desativar aviso de perda de ligação",disable_degraded_warning:"Desativar aviso de modo degradado",low_battery_threshold:"Limiar de aviso de bateria fraca (%)",section_display:"Exibição",section_interaction:"Interação",section_features:"Funcionalidades",section_warnings:"Avisos"}}},td={window_open:"Janela aberta",eco:"Eco",summer:"Verão",cooling:"Refrigeração",heating:"Aquecimento",cooling_off:"Refrigeração desligada",heating_off:"Aquecimento desligado",window_closed:"Janela fechada"},od={common:Qu,editor:ed,extra_states:td},id={version:"版本",current:"当前",current_humidity:"当前湿度",current_temperature:"当前温度",target_temperature:"目标温度"},nd={card:{climate:{disable_eco:"禁用节能显示",disable_menu:"禁用菜单",disable_battery_warning:"禁用电池警告",disable_buttons:"禁用加/减按钮",show_current_as_primary:"显示当前温度为主",show_secondary:"显示次要信息",prevent_interaction_on_scroll:"滚动时防止交互",disable_humidity:"关闭湿度显示",show_temperature_control:"显示温度控制",collapsible_controls:"可折叠控制",disable_connection_lost_warning:"关闭连接丢失警告",disable_degraded_warning:"关闭降级模式警告",low_battery_threshold:"低电量警告阈值 (%)",section_display:"显示",section_interaction:"交互",section_features:"功能",section_warnings:"警告"}}},rd={window_open:"窗口打开",eco:"节能",summer:"夏季",cooling:"冷却",heating:"加热",cooling_off:"冷却关闭",heating_off:"加热关闭",window_closed:"窗口关闭"},ad={common:id,editor:nd,extra_states:rd},sd={version:"версія",current:"поточний",current_humidity:"Поточна вологість",current_temperature:"Поточна температура",target_temperature:"Цільова температура"},ld={card:{climate:{disable_eco:"Прибрати еко",disable_menu:"Прибрати меню",disable_battery_warning:"Прибрати попередження про акумулятор",disable_buttons:"Прибрати кнопки плюс/мінус",show_current_as_primary:"Показувати поточну температуру як основну",show_secondary:"Показувати вторинну інформацію",prevent_interaction_on_scroll:"Запобігати взаємодії при прокручуванні",disable_humidity:"Вимкнути відображення вологості",show_temperature_control:"Показати контроль температури",collapsible_controls:"Згортані елементи керування",disable_connection_lost_warning:"Вимкнути попередження про втрату з'єднання",disable_degraded_warning:"Вимкнути попередження про деградований режим",low_battery_threshold:"Поріг попередження про низький заряд (%)",section_display:"Відображення",section_interaction:"Взаємодія",section_features:"Функції",section_warnings:"Попередження"}}},cd={window_open:"Вікно відкрите",eco:"Еко",summer:"Літо",cooling:"Охолодження",heating:"Опалення",cooling_off:"Охолодження вимкнено",heating_off:"Опалення вимкнено",window_closed:"Вікно закрите"},ud={common:sd,editor:ld,extra_states:cd},dd={version:"Έκδοση",current:"Tρέχουσα",current_humidity:"Τρέχουσα υγρασία",current_temperature:"Τρέχουσα θερμοκρασία",target_temperature:"Στόχος θερμοκρασίας"},hd={card:{climate:{disable_eco:"Απενεργοποίηση ένδειξης Eco",disable_menu:"Απενεργοποίηση μενού",disable_battery_warning:"Απενεργοποίηση προειδοποίησης μπαταρίας",disable_buttons:"Απενεργοποίηση κουμπιών Plus/Minus",show_current_as_primary:"Εμφάνιση τρέχουσας θερμοκρασίας ως κύρια",show_secondary:"Εμφάνιση δευτερευουσών πληροφοριών",prevent_interaction_on_scroll:"Αποτροπή αλληλεπίδρασης κατά την κύλιση",disable_humidity:"Απενεργοποίηση εμφάνισης υγρασίας",show_temperature_control:"Εμφάνιση ελέγχου θερμοκρασίας",collapsible_controls:"Πτυσσόμενα στοιχεία ελέγχου",disable_connection_lost_warning:"Απενεργοποίηση προειδοποίησης απώλειας σύνδεσης",disable_degraded_warning:"Απενεργοποίηση προειδοποίησης υποβαθμισμένης λειτουργίας",low_battery_threshold:"Όριο προειδοποίησης χαμηλής μπαταρίας (%)",section_display:"Εμφάνιση",section_interaction:"Αλληλεπίδραση",section_features:"Χαρακτηριστικά",section_warnings:"Προειδοποιήσεις"}}},pd={window_open:"Παράθυρο ανοιχτό",eco:"Εξοικονόμηση",summer:"Καλοκαίρι",cooling:"Ψύξη",heating:"Θέρμανση",cooling_off:"Ψύξη απενεργοποιημένη",heating_off:"Θέρμανση απενεργοποιημένη",window_closed:"Παράθυρο κλειστό"},_d={common:dd,editor:hd,extra_states:pd},md={version:"versie",current:"huidig",current_humidity:"Huidige luchtvochtigheid",current_temperature:"Huidige temperatuur",target_temperature:"Doeltemperatuur"},gd={card:{climate:{disable_eco:"Eco-weergave uitschakelen",disable_menu:"Menu uitschakelen",disable_battery_warning:"Batterijwaarschuwing uitschakelen",disable_buttons:"Plus/min-knoppen uitschakelen",show_current_as_primary:"Toon huidige temperatuur als primair",show_secondary:"Toon secundaire informatie",prevent_interaction_on_scroll:"Voorkom interactie tijdens scrollen",disable_humidity:"Vochtigheidsweergave uitschakelen",show_temperature_control:"Temperatuurregeling tonen",collapsible_controls:"Inklapbare bedieningselementen",disable_connection_lost_warning:"Waarschuwing verbinding verbroken uitschakelen",disable_degraded_warning:"Waarschuwing verminderde modus uitschakelen",low_battery_threshold:"Drempel batterijwaarschuwing (%)",section_display:"Weergave",section_interaction:"Interactie",section_features:"Functies",section_warnings:"Waarschuwingen"}}},bd={window_open:"Venster open",eco:"Eco",summer:"Zomer",cooling:"Koeling",heating:"Verwarming",cooling_off:"Koeling uit",heating_off:"Verwarming uit",window_closed:"Venster gesloten"},fd={common:md,editor:gd,extra_states:bd},vd={version:"versjon",current:"nåværende",current_humidity:"Nåværende luftfuktighet",current_temperature:"Nåværende temperatur",target_temperature:"Måltemperatur"},yd={card:{climate:{disable_eco:"Deaktiver eco visning",disable_menu:"Deaktiver meny",disable_battery_warning:"Deaktiver batterivarsel",disable_buttons:"Deaktiver pluss/minus knapper",show_current_as_primary:"Vis nåværende temperatur som primær",show_secondary:"Vis sekundær informasjon",prevent_interaction_on_scroll:"Forhindre interaksjon ved rulling",disable_humidity:"Deaktiver fuktighetsvisning",show_temperature_control:"Vis temperaturkontroll",collapsible_controls:"Sammenleggbare kontroller",disable_connection_lost_warning:"Deaktiver advarsel om tapt tilkobling",disable_degraded_warning:"Deaktiver advarsel om degradert modus",low_battery_threshold:"Terskel for advarsel om lavt batteri (%)",section_display:"Visning",section_interaction:"Interaksjon",section_features:"Funksjoner",section_warnings:"Advarsler"}}},wd={window_open:"Vindu åpent",eco:"Eco",summer:"Sommer",cooling:"Kjøling",heating:"Oppvarming",cooling_off:"Kjøling av",heating_off:"Oppvarming av",window_closed:"Vindu lukket"},kd={common:vd,editor:yd,extra_states:wd},zd={version:"Verze",current:"Aktuální",current_humidity:"Aktuální vlhkost",current_temperature:"Aktuální teplota",target_temperature:"Cílová teplota"},xd={card:{climate:{disable_eco:"Zakázat eco",disable_menu:"Zakázat menu",disable_battery_warning:"Zakázat upozornění baterie",disable_buttons:"Zakázat tlačítka plus/minus",show_current_as_primary:"Zobrazit aktuální teplotu jako hlavní",show_secondary:"Zobrazit sekundární informace",prevent_interaction_on_scroll:"Zabránit interakci při posouvání",disable_humidity:"Zakázat zobrazení vlhkosti",show_temperature_control:"Zobrazit ovládání teploty",collapsible_controls:"Sbalitelné ovládání",disable_connection_lost_warning:"Vypnout upozornění na ztrátu spojení",disable_degraded_warning:"Vypnout upozornění na zhoršený režim",low_battery_threshold:"Práh upozornění na nízkou baterii (%)",section_display:"Zobrazení",section_interaction:"Interakce",section_features:"Funkce",section_warnings:"Upozornění"}}},Ad={window_open:"Okno otevřeno",eco:"Eco",summer:"Léto",cooling:"Chlazení",heating:"Topení",cooling_off:"Chlazení vypnuto",heating_off:"Topení vypnuto",window_closed:"Okno zavřeno"},Ed={common:zd,editor:xd,extra_states:Ad},Cd={version:"različica",current:"trenutno",current_humidity:"Trenutna vlažnost",current_temperature:"Trenutna temperatura",target_temperature:"Ciljna temperatura"},Md={card:{climate:{disable_eco:"Onemogoči prikaz eco",disable_menu:"Onemogoči meni",disable_battery_warning:"Onemogoči opozorilo o bateriji",disable_buttons:"Onemogoči gumbe plus/minus",show_current_as_primary:"Prikaži trenutno temperaturo kot primarno",show_secondary:"Prikaži sekundarne informacije",prevent_interaction_on_scroll:"Prepreči interakcijo med drsenjem",disable_humidity:"Onemogoči prikaz vlažnosti",show_temperature_control:"Prikaži nadzor temperature",collapsible_controls:"Zložljivi kontrolniki",disable_connection_lost_warning:"Onemogoči opozorilo o izgubi povezave",disable_degraded_warning:"Onemogoči opozorilo o zmanjšanem načinu",low_battery_threshold:"Prag opozorila za nizko baterijo (%)",section_display:"Prikaz",section_interaction:"Interakcija",section_features:"Funkcije",section_warnings:"Opozorila"}}},$d={window_open:"Okno odprto",eco:"Eko",summer:"Poletje",cooling:"Hlajenje",heating:"Ogrevanje",cooling_off:"Hlajenje izklopljeno",heating_off:"Ogrevanje izklopljeno",window_closed:"Okno zaprto"},Sd={common:Cd,editor:Md,extra_states:$d},Td={version:"version",current:"Nuvarande",current_humidity:"Nuvarande luftfuktighet",current_temperature:"Nuvarande temperatur",target_temperature:"Måltemperatur"},jd={card:{climate:{disable_eco:"Inaktivera eco visning",disable_menu:"Inaktivera meny",disable_battery_warning:"Inaktivera batterivarning",disable_buttons:"Inaktivera plus/minus knappar",show_current_as_primary:"Visa aktuell temperatur som primär",show_secondary:"Visa sekundär information",prevent_interaction_on_scroll:"Förhindra interaktion vid rullning",disable_humidity:"Inaktivera fuktighetsvisning",show_temperature_control:"Visa temperaturkontroll",collapsible_controls:"Ihopfällbara kontroller",disable_connection_lost_warning:"Inaktivera varning för tappad anslutning",disable_degraded_warning:"Inaktivera varning för försämrat läge",low_battery_threshold:"Tröskelvärde för varning om låg batterinivå (%)",section_display:"Visning",section_interaction:"Interaktion",section_features:"Funktioner",section_warnings:"Varningar"}}},Pd={window_open:"Fönster öppet",eco:"Eco",summer:"Sommar",cooling:"Kylning",heating:"Uppvärmning",cooling_off:"Kylning av",heating_off:"Uppvärmning av",window_closed:"Fönster stängt"},Hd={common:Td,editor:jd,extra_states:Pd},Od={version:"Версия",current:"Текущ",current_humidity:"Текуща влажност",current_temperature:"Текуща температура",target_temperature:"Целева температура"},Id={card:{climate:{disable_eco:"Деактивиране на показване на еко",disable_menu:"Деактивиране на менюто",disable_battery_warning:"Деактивиране на предупреждение за батерията",disable_buttons:"Деактивиране на бутоните плюс/минус",show_current_as_primary:"Показване на текущата температура като основна",show_secondary:"Показване на вторична информация",prevent_interaction_on_scroll:"Предотвратяване на взаимодействие при превъртане",disable_humidity:"Изключване на показването на влажността",show_temperature_control:"Показване на контрол на температурата",collapsible_controls:"Сгъваеми контроли",disable_connection_lost_warning:"Изключване на предупреждение за загубена връзка",disable_degraded_warning:"Изключване на предупреждение за влошен режим",low_battery_threshold:"Праг на предупреждение за изтощена батерия (%)",section_display:"Дисплей",section_interaction:"Взаимодействие",section_features:"Функции",section_warnings:"Предупреждения"}}},Bd={window_open:"Прозорецът е отворен",eco:"Екологичен режим",summer:"Лято",cooling:"Охлаждане",heating:"Отопление",cooling_off:"Охлаждането е изключено",heating_off:"Отоплението е изключено",window_closed:"Прозорецът е затворен"},Nd={common:Od,editor:Id,extra_states:Bd},Ld={version:"Versio",current:"Nykyinen",current_humidity:"Nykyinen kosteus",current_temperature:"Nykyinen lämpötila",target_temperature:"Tavoitelämpötila"},Dd={card:{climate:{disable_eco:"Poista Eco -ilmoitus käytöstä",disable_menu:"Poista valikko käytöstä",disable_battery_warning:"Poista akun varoitus käytöstä",disable_buttons:"Poista plus/miinus -painikkeet käytöstä",show_current_as_primary:"Näytä nykyinen lämpötila ensisijaisena",show_secondary:"Näytä toissijaiset tiedot",prevent_interaction_on_scroll:"Estä vuorovaikutus vieritettäessä",disable_humidity:"Poista kosteusnäyttö käytöstä",show_temperature_control:"Näytä lämpötilan säätö",collapsible_controls:"Kokoon taittuvat säätimet",disable_connection_lost_warning:"Poista yhteyden katkeamisen varoitus käytöstä",disable_degraded_warning:"Poista heikentyneen tilan varoitus käytöstä",low_battery_threshold:"Alhaisen akun varoituskynnys (%)",section_display:"Näyttö",section_interaction:"Vuorovaikutus",section_features:"Ominaisuudet",section_warnings:"Varoitukset"}}},Vd={window_open:"Ikkuna auki",eco:"Eco",summer:"Kesä",cooling:"Jäähdytys",heating:"Lämmitys",cooling_off:"Jäähdytys pois päältä",heating_off:"Lämmitys pois päältä",window_closed:"Ikkuna kiinni"},Rd={common:Ld,editor:Dd,extra_states:Vd},Ud={version:"versiune",current:"curent",current_humidity:"Umiditate curentă",current_temperature:"Temperatură curentă",target_temperature:"Temperatură țintă"},Fd={card:{climate:{disable_eco:"Dezactivează eco",disable_menu:"Dezactivează meniul",disable_battery_warning:"Dezactivează avertizarea bateriei",disable_buttons:"Dezactivează butoanele plus/minus",show_current_as_primary:"Afișează temperatura curentă ca principală",show_secondary:"Afișează informații secundare",prevent_interaction_on_scroll:"Previne interacțiunea la derulare",disable_humidity:"Dezactivează afișarea umidității",show_temperature_control:"Afișează controlul temperaturii",collapsible_controls:"Controale pliabile",disable_connection_lost_warning:"Dezactivează avertismentul de pierdere a conexiunii",disable_degraded_warning:"Dezactivează avertismentul de mod degradat",low_battery_threshold:"Prag avertisment baterie descărcată (%)",section_display:"Afișare",section_interaction:"Interacțiune",section_features:"Funcționalități",section_warnings:"Avertismente"}}},Gd={window_open:"Fereastră deschisă",eco:"Eco",summer:"Vara",cooling:"Răcire",heating:"Încălzire",cooling_off:"Răcire oprită",heating_off:"Încălzire oprită",window_closed:"Fereastră închisă"},Kd={common:Ud,editor:Fd,extra_states:Gd},Zd={version:"Versió",current:"Actual",current_humidity:"Humitat actual",current_temperature:"Temperatura actual",target_temperature:"Temperatura objectiu"},qd={card:{climate:{disable_eco:"Desactivar indicador eco",disable_menu:"Desactivar menú",disable_battery_warning:"Desactivar advertència de bateria",disable_buttons:"Desactivar botons de més/menys",show_current_as_primary:"Mostra la temperatura actual com a principal",show_secondary:"Mostra informació secundària",prevent_interaction_on_scroll:"Evitar la interacció en desplaçar-se",disable_humidity:"Desactivar la visualització d'humitat",show_temperature_control:"Mostra el control de temperatura",collapsible_controls:"Controls plegables",disable_connection_lost_warning:"Desactiva avís de pèrdua de connexió",disable_degraded_warning:"Desactiva avís de mode degradat",low_battery_threshold:"Llindar d'avís de bateria baixa (%)",section_display:"Visualització",section_interaction:"Interacció",section_features:"Funcionalitats",section_warnings:"Avisos"}}},Wd={window_open:"Finestra oberta",eco:"Eco",summer:"Estiu",cooling:"Refredament",heating:"Escalfament",cooling_off:"Refredament apagat",heating_off:"Escalfament apagat",window_closed:"Finestra tancada"},Xd={common:Zd,editor:qd,extra_states:Wd},Yd={version:"versijas",current:"pašreizējais",current_humidity:"Pašreizējais mitrums",current_temperature:"Pašreizējā temperatūra",target_temperature:"Mērķa temperatūra"},Jd={card:{climate:{disable_eco:"Atspējot ekonomisko režīmu",disable_menu:"Atspējot izvēlni",disable_battery_warning:"Atspējot baterijas brīdinājumu",disable_buttons:"Atspējot plus/mīnus pogas",show_current_as_primary:"Rādīt pašreizējo temperatūru kā galveno",show_secondary:"Rādīt sekundāro informāciju",prevent_interaction_on_scroll:"Novērst mijiedarbību ritinot",disable_humidity:"Izslēgt mitruma rādījumu",show_temperature_control:"Rādīt temperatūras kontroli",collapsible_controls:"Salocāmas vadīklas",disable_connection_lost_warning:"Izslēgt savienojuma zaudēšanas brīdinājumu",disable_degraded_warning:"Izslēgt pasliktināta režīma brīdinājumu",low_battery_threshold:"Zemas baterijas brīdinājuma slieksnis (%)",section_display:"Displejs",section_interaction:"Mijiedarbība",section_features:"Funkcijas",section_warnings:"Brīdinājumi"}}},Qd={window_open:"Logs atvērts",eco:"Eko režīms",summer:"Vasaras režīms",cooling:"Dzesēšana",heating:"Apkure",cooling_off:"Dzesēšana izslēgta",heating_off:"Apkure izslēgta",window_closed:"Logs aizvērts"},eh={common:Yd,editor:Jd,extra_states:Qd},th={version:"versión",current:"Actual"},oh={card:{climate:{disable_eco:"Desactivar eco",disable_menu:"Desactivar menú",disable_battery_warning:"Desactivar alerta de batería",disable_buttons:"Desactivar botóns máis/menos",disable_humidity:"Desactivar visualización de humidade",show_temperature_control:"Mostrar control de temperatura",collapsible_controls:"Controis pregables",disable_connection_lost_warning:"Desactivar aviso de perda de conexión",disable_degraded_warning:"Desactivar aviso de modo degradado",low_battery_threshold:"Limiar de aviso de batería baixa (%)",section_display:"Visualización",section_interaction:"Interacción",section_features:"Funcionalidades",section_warnings:"Avisos"}}},ih={window_open:"Fiestra aberta",eco:"Eco",summer:"Verán"},nh={common:th,editor:oh,extra_states:ih},rh={version:"버전",current:"현재"},ah={card:{climate:{disable_eco:"절전 버튼 표시 하지 않기",disable_menu:"메뉴 표시 하지 않기",disable_battery_warning:"배터리 경고 표시 하지 않기",disable_buttons:"온도 조절 버튼 표시 하지 않기",disable_humidity:"습도 표시 끄기",show_current_as_primary:"현재 온도를 기본으로 표시",show_secondary:"보조 정보 표시",prevent_interaction_on_scroll:"스크롤 시 상호작용 방지",show_temperature_control:"온도 조절 표시",collapsible_controls:"접을 수 있는 컨트롤",disable_connection_lost_warning:"연결 끊김 경고 끄기",disable_degraded_warning:"저하 모드 경고 끄기",low_battery_threshold:"배터리 부족 경고 임계값 (%)",section_display:"표시",section_interaction:"상호 작용",section_features:"기능",section_warnings:"경고"}}},sh={window_open:"창문이 열림",eco:"절전",summer:"여름"},lh={common:rh,editor:ah,extra_states:sh},ch={version:"versija",current:"dabartinė"},uh={card:{climate:{disable_eco:"Išjungti ECO rėžimą",disable_menu:"Išjungti meniu",disable_battery_warning:"Išjungti baterijos pranešimą",disable_buttons:"Nerodyti plius/minus mygtukų",disable_humidity:"Išjungti drėgmės rodymą",show_temperature_control:"Rodyti temperatūros valdymą",collapsible_controls:"Sulankstomi valdikliai",disable_connection_lost_warning:"Išjungti ryšio praradimo įspėjimą",disable_degraded_warning:"Išjungti pabloginto režimo įspėjimą",low_battery_threshold:"Žemo akumuliatoriaus įspėjimo riba (%)",section_display:"Rodymas",section_interaction:"Sąveika",section_features:"Funkcijos",section_warnings:"Įspėjimai"}}},dh={window_open:"Atidarytas langas",eco:"ECO",summer:"Vasaros rėžimas"},hh={common:ch,editor:uh,extra_states:dh},ph={version:"versão",current:"atual",current_humidity:"Umidade atual",current_temperature:"Temperatura atual",target_temperature:"Temperatura alvo"},_h={card:{climate:{disable_eco:"Desabilitar eco",disable_menu:"Desabilitar menu",disable_battery_warning:"Desabilitar aviso de bateria",disable_buttons:"Desabilitar botões mais/menos",show_current_as_primary:"Mostrar temperatura atual como principal",show_secondary:"Mostrar informações secundárias",prevent_interaction_on_scroll:"Prevenir interação ao rolar",disable_humidity:"Desativar exibição de umidade",show_temperature_control:"Mostrar controle de temperatura",collapsible_controls:"Controles recolhíveis",disable_connection_lost_warning:"Desativar aviso de perda de conexão",disable_degraded_warning:"Desativar aviso de modo degradado",low_battery_threshold:"Limite de aviso de bateria fraca (%)",section_display:"Exibição",section_interaction:"Interação",section_features:"Funcionalidades",section_warnings:"Avisos"}}},mh={window_open:"Janela aberta",window_closed:"Janela fechada",eco:"Eco",summer:"Verão",cooling:"Resfriando",heating:"Aquecendo",cooling_off:"Resfriamento desligado",heating_off:"Aquecimento desligado"},gh={common:ph,editor:_h,extra_states:mh};const bh={en:nu,de:cu,fr:_u,ru:vu,sk:Object.freeze({__proto__:null,common:Au,default:Mu,editor:Eu,extra_states:Cu}),hr:Object.freeze({__proto__:null,common:$u,default:ju,editor:Su,extra_states:Tu}),hu:Object.freeze({__proto__:null,common:Pu,default:Iu,editor:Hu,extra_states:Ou}),pl:xu,da:Object.freeze({__proto__:null,common:Bu,default:Du,editor:Nu,extra_states:Lu}),es:Object.freeze({__proto__:null,common:Vu,default:Fu,editor:Ru,extra_states:Uu}),tr:Object.freeze({__proto__:null,common:Gu,default:qu,editor:Ku,extra_states:Zu}),it:Object.freeze({__proto__:null,common:Wu,default:Ju,editor:Xu,extra_states:Yu}),pt:Object.freeze({__proto__:null,common:Qu,default:od,editor:ed,extra_states:td}),cn:Object.freeze({__proto__:null,common:id,default:ad,editor:nd,extra_states:rd}),uk:Object.freeze({__proto__:null,common:sd,default:ud,editor:ld,extra_states:cd}),el:Object.freeze({__proto__:null,common:dd,default:_d,editor:hd,extra_states:pd}),nl:Object.freeze({__proto__:null,common:md,default:fd,editor:gd,extra_states:bd}),no:Object.freeze({__proto__:null,common:vd,default:kd,editor:yd,extra_states:wd}),cs:Object.freeze({__proto__:null,common:zd,default:Ed,editor:xd,extra_states:Ad}),sl:Object.freeze({__proto__:null,common:Cd,default:Sd,editor:Md,extra_states:$d}),sv:Object.freeze({__proto__:null,common:Td,default:Hd,editor:jd,extra_states:Pd}),bg:Object.freeze({__proto__:null,common:Od,default:Nd,editor:Id,extra_states:Bd}),fi:Object.freeze({__proto__:null,common:Ld,default:Rd,editor:Dd,extra_states:Vd}),ro:Object.freeze({__proto__:null,common:Ud,default:Kd,editor:Fd,extra_states:Gd}),ca:Object.freeze({__proto__:null,common:Zd,default:Xd,editor:qd,extra_states:Wd}),lv:Object.freeze({__proto__:null,common:Yd,default:eh,editor:Jd,extra_states:Qd}),gl:Object.freeze({__proto__:null,common:th,default:nh,editor:oh,extra_states:ih}),kr:Object.freeze({__proto__:null,common:rh,default:lh,editor:ah,extra_states:sh}),lt:Object.freeze({__proto__:null,common:ch,default:hh,editor:uh,extra_states:dh}),"pt-BR":Object.freeze({__proto__:null,common:ph,default:gh,editor:_h,extra_states:mh})},fh="en";function vh(e,t){try{return e.split(".").reduce(((e,t)=>e[t]),bh[t])}catch(e){return}}function yh(e,t){for(const o of function(e){const t=e?.locale?.language??fh,o=[t],i=t.split(/[-_]/)[0];return i&&i!==t&&o.push(i),o.includes(fh)||o.push(fh),o}(e)){const e=vh(t,o);if(void 0!==e)return e}}function wh({hass:e,string:t,search:o="",replace:i=""}){let n=yh(e,t);return""!==o&&""!==i&&"string"==typeof n&&(n=n.replace(o,i)),n??t}function kh(e){return function(t){return yh(e,t)??t}}let zh;function xh(e){const t=e.locale?.language??fh;zh&&zh.language===t||(zh={language:t,custom:kh(e),mushroom:br(e)});const{custom:o,mushroom:i}=zh;return t=>{const n=o(t);if(n&&n!==t)return n;const r=i(t);return r&&r!==t?r:e.localize(t)}}function Ah(e,t,o){return!e||(e.locale!==t.locale||e.themes!==t.themes||e.config.unit_system!==t.config.unit_system||e.connected!==t.connected||e.localize!==t.localize||e.formatEntityState!==t.formatEntityState||e.formatEntityAttributeValue!==t.formatEntityAttributeValue||o.some((o=>null!=o&&e.states[o]!==t.states[o])))}class Eh{constructor(e){this._open=!1,this._onDocumentPointerDown=e=>{const t=e.composedPath(),o=this._host.shadowRoot?.querySelector(".preset-select");o&&(t.includes(o)||this.setOpen(!1))},this._onDocumentKeyDown=e=>{"Escape"===e.key&&this.setOpen(!1)},this._host=e,e.addController(this)}get open(){return this._open}setOpen(e){this._open=e,e?this._addListeners():this._removeListeners(),this._host.requestUpdate()}hostConnected(){this._open&&this._addListeners()}hostDisconnected(){this._removeListeners(),this._open=!1,this._host.requestUpdate()}_addListeners(){window.addEventListener("pointerdown",this._onDocumentPointerDown),window.addEventListener("keydown",this._onDocumentKeyDown)}_removeListeners(){window.removeEventListener("pointerdown",this._onDocumentPointerDown),window.removeEventListener("keydown",this._onDocumentKeyDown)}}const Ch=h`
  .preset-select {
    position: absolute;
    top: 0;
    left: 0;
...
`,Sh={temperature_control:"mdi:thermometer",hvac_mode_control:"mdi:thermostat"};hc({type:pc,name:"Better Thermostat Mini Climate Card",description:"Card for climate entity"});let Th=class extends cc{constructor(){super(...arguments),this._presetOverlay=new Eh(this)}static async getConfigElement(){return await Promise.resolve().then((function(){return Hp})),document.createElement(_c)}static async getStubConfig(e){return{type:`custom:${pc}`,entity:Gc(e)}}get _controls(){if(!this._config||!this._stateObj)return[];const e=this._stateObj,t=[];var o;return(Se(o=e,Ic)&&null!=o.attributes.temperature||Se(o,Bc)&&null!=o.attributes.target_temp_low&&null!=o.attributes.target_temp_high)&&this._config.show_temperature_control&&t.push("temperature_control"),((e,t)=>void 0===t?(e.attributes.hvac_modes||[]).length>0:(e.attributes.hvac_modes||[]).some((e=>t.includes(e))))(e,["heat","off"])&&t.push("hvac_mode_control"),t}get hasControls(){return this._controls.length>0}_onControlTap(e,t){t.stopPropagation(),this._activeControl=e}setConfig(e){super.setConfig({tap_action:{action:"toggle"},hold_action:{action:"more-info"},...e}),this.updateActiveControl()}updated(e){super.updated(e),this.hass&&e.has("hass")&&this.updateActiveControl()}shouldUpdate(e){if(1===e.size&&e.has("hass")){return Ah(e.get("hass"),this.hass,[this._config?.entity,this._config?.window_sensor,this._config?.humidity_sensor,this._config?.preset_entity])}return!0}updateActiveControl(){const e=!!this._activeControl&&this._controls.includes(this._activeControl);this._activeControl=e?this._activeControl:this._controls[0]}_handleAction(e){(async(e,t,o,i)=>{$e(e,"hass-action",{config:o,action:i})})(this,this.hass,this._config,e.detail.action)}render(){if(!this.hass||!this._config||!this._config.entity)return J;const e=this._stateObj;if(!e)return this.renderNotFound(this._config);const t=this._config.name||e.attributes.friendly_name||"",o=this._config.icon,i=$t(this._config),n=function(e,t){return"entity-picture"===t?function(e){return e.attributes.entity_picture_local||e.attributes.entity_picture}(e):void 0}(e,i.icon_type),r=Zc(this.hass,e,this._config),a=!1===e.attributes.call_for_heat;let s=this.hass.formatEntityState(e);if(e.attributes.hvac_action&&"off"!==e.attributes.hvac_action&&(s=this.hass.formatEntityAttributeValue(e,"hvac_action")),null!=e.attributes.current_temperature){let t=this.hass.formatEntityAttributeValue(e,"current_temperature");t||(t=`${e.attributes.current_temperature} ${this.hass.config.unit_system.temperature}`);const o=wh({hass:this.hass,string:"extra_states.window_open"}),i=wh({hass:this.hass,string:"extra_states.summer"})||"Summer";let n="";const l=qc(this.hass,e,this._config);l&&(n=` ⸱ ${l}`),s+=` ⸱ ${r?`(${o}) `:a?`(${i}) `:""}${t}${n}`}const l=rt(this.hass),c=!this._config.disable_all_buttons&&(!this._config.collapsible_controls||dt(e))&&this._controls.length,u=Lc(this.hass,e,this._config.preset_entity),d=u.length>0,h=!c&&!this._config.disable_presets&&d&&(!this._config.collapsible_controls||dt(e)),p=e.attributes.hvac_action||"off",_={};_["--action-color"]=bc(Ac(p),.6);const m=Dc(this.hass,e,this._config.preset_entity);if(void 0!==m&&(!this._config.preset_entity||xc(m))){const e=zc(m);_["--action-color"]=bc(e,.6),_["--bt-color-heat"]=e}r?_["--action-color"]="var(--info-color)":a?_["--action-color"]="var(--bt-color-summer)":"off"===p&&(_["--action-color"]="rgba(0, 0, 0, 0)");const g=!!this._config.show_all_presets;return W`
      <ha-card
        class=${Ae({"fill-container":i.fill_container})}
        style=${Me({...Cc(this._config.colors),..._})}
      >
    ...
    `}renderPresetButton(e,t,o){const i=t===o?zc(t):"var(--bt-color-grey)",n={"--icon-color":i,"--bg-color":bc(i,.2)},r=Vc(this.hass,e,t,this._config?.preset_entity);return W`
      <mushroom-button
        style=${Me(n)}
        .mode=${t}
        .disabled=${!ht(e)}
    ...
    `}async firstUpdated(e){super.firstUpdated(e),await Promise.all([Mt("mushroom-badge-icon",(()=>Promise.resolve().then((function(){return vr})))),Mt("mushroom-card",(()=>Promise.resolve().then((function(){return wr})))),Mt("mushroom-shape-avatar",(()=>Promise.resolve().then((function(){return zr})))),Mt("mushroom-shape-icon",(()=>Promise.resolve().then((function(){return Cr})))),Mt("mushroom-state-info",(()=>Promise.resolve().then((function(){return $r})))),Mt("mushroom-state-item",(()=>Promise.resolve().then((function(){return Tr})))),Mt("mushroom-button",(()=>Promise.resolve().then((function(){return fp}))))])}renderIcon(e,t){const o=ht(e),i=Zc(this.hass,e,this._config),n=!1===e.attributes.call_for_heat,r=!0===e.attributes.eco_mode,a=e.attributes.hvac_action,s=a&&"idle"!==a&&"off"!==a?Ac(a):zc(e.state),l={};return l["--icon-color"]=s,l["--shape-color"]=bc(s,.2),i?(l["--icon-color"]="var(--info-color)",l["--shape-color"]="rgba(0,0,0, 0.1)"):n?(l["--icon-color"]="var(--bt-color-summer)",l["--shape-color"]=bc("var(--bt-color-summer)",.2)):r&&(l["--icon-color"]="var(--bt-color-eco)",l["--shape-color"]=bc("var(--bt-color-eco)",.2)),W`
      <mushroom-shape-icon
        slot="icon"
        .disabled=${!o}
        style=${Me(l)}
    ...
    `}renderBadge(e){if(!ht(e))return super.renderBadge(e);const t=Yc(e,this._config),o=Jc(e,this._config);return Qc(e,this._config)?W`
        <mushroom-badge-icon
          slot="badge"
          .icon=${"mdi:alert"}
          title=${wh({hass:this.hass,string:"extra_states.degraded_mode"})}
      ...
      `:o?W`
        <mushroom-badge-icon
          ...
          title=${wh({hass:this.hass,string:"extra_states.connection_lost",search:"{name}",replace:this.hass?.states?.[o]?.attributes?.friendly_name??o})}
      ...
      `:t?W`
        <mushroom-badge-icon
          ...
          title=${wh({hass:this.hass,string:"extra_states.low_battery",search:"{name}",replace:t.name})}
          @click=${e=>this._handleLowBatteryClick(e,t)}
          style=${Me({"--icon-color":"var(--error-color, #f44336)","--main-color":"var(--bt-badge-background)",border:"1px solid var(--error-color, #f44336)",borderRadius:"50%"})}
        ></mushroom-badge-icon>
      `:this.renderActionBadge(e)}_handleErrorClick(e,t){e.stopPropagation(),e.preventDefault(),t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}_handleLowBatteryClick(e,t){e.stopPropagation(),e.preventDefault();const o=t?.name;o&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:o},bubbles:!0,composed:!0}))}renderActionBadge(e){const t=e.attributes.hvac_action,o=Zc(this.hass,e,this._config),i=!1===e.attributes.call_for_heat;if(!(t&&"off"!==t||o||i))return J;let n=function(e){const t=Sc[e];if(t)return t;const o=fc[e];return o?Tc(o):""}(t||"off");if(o?n="mdi:window-open-variant":i&&(n="mdi:white-balance-sunny"),!n)return J;let r=Ac(t||"off");return i&&!o&&(r="var(--bt-color-summer)"),W`
      <mushroom-badge-icon
        slot="badge"
        .icon=${n}
    ...
    `}renderOtherControls(){const e=this._controls.filter((e=>e!=this._activeControl));return W`
      ${e.map((e=>W`
          <mushroom-button @click=${t=>this._onControlTap(e,t)}>
            <ha-icon .icon=${Sh[e]}></ha-icon>
          </mushroom-button>
        `))}
    `}renderPresetFeature(e){if(this._config?.disable_presets)return J;const t=this._config?.preset_entity,o=Lc(this.hass,e,t);if(0===o.length)return J;const i=Dc(this.hass,e,t);if(this._config?.show_all_presets)return W`${o.map((t=>this.renderPresetButton(e,t,i)))}`;const n={},r=i??"none";if(null!=i){const e=zc(i);n["--icon-color"]=e,n["--bg-color"]=bc(e,.2)}const a=null!=i?jc(i):Tc("none"),s=null!=i?Vc(this.hass,e,i,t):wh({hass:this.hass,string:"extra_states.presets"});if(1===o.length){const i=Vc(this.hass,e,o[0],t);return W`
        <mushroom-button
          style=${Me(n)}
          .mode=${r}
          title=${i}
    ...
    `}triggerModeChange(e){const t=this._stateObj;t&&Rc(this.hass,t,e,this._config?.preset_entity)&&this._presetOverlay.setOpen(!1)}renderActiveControl(e){const t=["heat","off"],o=$t(this._config);switch(this._activeControl){case"temperature_control":return W`
        ...
        `;case"hvac_mode_control":return W`
          ...
          ></mushroom-climate-hvac-modes-control>
        `;default:return J}}static get styles(){return[super.styles,uc,Mh,Mc,Ch,$h,h`
        :host {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{I:jh}=de,Ph=()=>document.createComment(""),Hh=(e,t,o)=>{const i=e._$AA.parentNode,n=void 0===t?e._$AB:t._$AA;if(void 0===o){const t=i.insertBefore(Ph(),n),r=i.insertBefore(Ph(),n);o=new jh(t,r,e,e.options)}else{const t=o._$AB.nextSibling,r=o._$AM,a=r!==e;if(a){let t;o._$AQ?.(e),o._$AM=e,void 0!==o._$AP&&(t=e._$AU)!==r._$AU&&o._$AP(t)}if(t!==n||a){let e=o._$AA;for(;e!==t;){const t=e.nextSibling;i.insertBefore(e,n),e=t}}}return o},Oh=(e,t,o=e)=>(e._$AI(t,o),e),Ih={},Bh=e=>{e._$AR(),e._$AA.remove()},Nh=(e,t)=>{const o=e._$AN;if(void 0===o)return!1;for(const e of o)e._$AO?.(t,!1),Nh(e,t);return!0},Lh=e=>{let t,o;do{if(void 0===(t=e._$AM))break;o=t._$AN,o.delete(e),e=t}while(0===o?.size)},Dh=e=>{for(let t;t=e._$AM;e=t){let o=t._$AN;if(void 0===o)t._$AN=o=new Set;else if(o.has(e))break;o.add(e),Uh(t)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Vh(e){void 0!==this._$AN?(Lh(this),this._$AM=e,Dh(this)):this._$AM=e}function Rh(e,t=!1,o=0){const i=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(i))for(let e=o;e<i.length;e++)Nh(i[e],!1),Lh(i[e]);else null!=i&&(Nh(i,!1),Lh(i));else Nh(this,e)}const Uh=e=>{e.type==ke&&(e._$AP??=Rh,e._$AQ??=Vh)};class Fh extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,o){super._$AT(e,t,o),Dh(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Nh(this,e),Lh(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}class Gh{constructor(e,{target:t,config:o,callback:i,skipInitial:n}){this.t=new Set,this.o=!1,this.i=!1,this.h=e,null!==t&&this.t.add(t??e),this.l=o,this.o=n??this.o,this.callback=i,window.ResizeObserver?(this.u=new ResizeObserver((e=>{this.handleChanges(e),this.h.requestUpdate()})),e.addController(this)):console.warn("ResizeController error: browser does not support ResizeObserver.")}handleChanges(e){this.value=this.callback?.(e,this.u)}hostConnected(){for(const e of this.t)this.observe(e)}hostDisconnected(){this.disconnect()}async hostUpdated(){!this.o&&this.i&&this.handleChanges([]),this.i=!1}observe(e){this.t.add(e),this.u.observe(e,this.l),this.i=!0,this.h.requestUpdate()}unobserve(e){this.t.delete(e),this.u.unobserve(e)}disconnect(){this.u.disconnect()}target(e){return Kh(this,e)}}const Kh=ze(class extends Fh{constructor(){super(...arguments),this.observing=!1}render(e,t){}update(e,[t,o]){this.controller=t,this.part=e,this.observe=o,!1===o?(t.unobserve(e.element),this.observing=!1):!1===this.observing&&(t.observe(e.element),this.observing=!0)}disconnected(){this.controller?.unobserve(this.part.element),this.observing=!1}reconnected(){!1!==this.observe&&!1===this.observing&&(this.controller?.observe(this.part.element),this.observing=!0)}}),Zh="better-thermostat-normal-climate-card",qh=`${Zh}-editor`,Wh=["climate"];var Xh="M13 14H11V9H13M13 18H11V16H13M1 21H23L12 2L1 21Z",Yh="M16.95,16.95L14.83,14.83C15.55,14.1 16,13.1 16,12C16,11.26 15.79,10.57 15.43,10L17.6,7.81C18.5,9 19,10.43 19,12C19,13.93 18.22,15.68 16.95,16.95M12,5C13.57,5 15,5.5 16.19,6.4L14,8.56C13.43,8.21 12.74,8 12,8A4,4 0 0,0 8,12C8,13.1 8.45,14.1 9.17,14.83L7.05,16.95C5.78,15.68 5,13.93 5,12A7,7 0 0,1 12,5M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2Z",Jh="M21 20V2H3V20H1V23H23V20M19 4V11H17V4M5 4H7V11H5M5 20V13H7V20M9 20V4H15V20M17 20V13H19V20Z";const Qh=h`
  :host {
    position: relative;
    display: block;
    height: 100%;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,ip=(e,t,o)=>{const i=new Map;for(let n=t;n<=o;n++)i.set(e[n],n);return i},np=ze(class extends xe{constructor(e){if(super(e),e.type!==ke)throw Error("repeat() can only be used in text expressions")}dt(e,t,o){let i;void 0===o?o=t:void 0!==t&&(i=t);const n=[],r=[];let a=0;for(const t of e)n[a]=i?i(t,a):a,r[a]=o(t,a),a++;return{values:r,keys:n}}render(e,t,o){return this.dt(e,t,o).values}update(e,[t,o,i]){const n=(e=>e._$AH)(e),{values:r,keys:a}=this.dt(t,o,i);if(!Array.isArray(n))return this.ut=a,r;const s=this.ut??=[],l=[];let c,u,d=0,h=n.length-1,p=0,_=r.length-1;for(;d<=h&&p<=_;)if(null===n[d])d++;else if(null===n[h])h--;else if(s[d]===a[p])l[p]=Oh(n[d],r[p]),d++,p++;else if(s[h]===a[_])l[_]=Oh(n[h],r[_]),h--,_--;else if(s[d]===a[_])l[_]=Oh(n[d],r[_]),Hh(e,l[_+1],n[d]),d++,_--;else if(s[h]===a[p])l[p]=Oh(n[h],r[p]),Hh(e,n[d],n[h]),h--,p++;else if(void 0===c&&(c=ip(a,p,_),u=ip(s,d,h)),c.has(s[d]))if(c.has(s[h])){const t=u.get(a[p]),o=void 0!==t?n[t]:null;if(null===o){const t=Hh(e,n[d]);Oh(t,r[p]),l[p]=t}else l[p]=Oh(o,r[p]),Hh(e,n[d],o),n[t]=null;p++}else Bh(n[h]),h--;else Bh(n[d]),d++;for(;p<=_;){const t=Hh(e,l[_+1]);Oh(t,r[p]),l[p++]=t}for(;d<=h;){const e=n[d++];null!==e&&Bh(e)}return this.ut=a,((e,t=Ih)=>{e._$AH=t})(e,l),Y}});let rp=class extends _e{render(){return X`
    <svg
  ...
  `,n([ve()],rp.prototype,"path",void 0),n([ve({attribute:!1})],rp.prototype,"secondaryPath",void 0),n([ve({attribute:!1})],rp.prototype,"viewBox",void 0),rp=n([ge("cts-ha-svg-icon")],rp);let ap=class extends _e{constructor(){super(...arguments),this.vertical=!1,this.disabled=!1,this.hideOptionLabel=!1}_handleOptionClick(e){if(this.disabled)return;const t=e.currentTarget.value;t!==this.value&&$e(this,"value-changed",{value:t})}_handleKeydown(e){if(this.disabled||!this.options?.length)return;const t=this.options.findIndex((e=>e.value===this.value));let o;if("ArrowRight"===e.key||"ArrowDown"===e.key)o=-1===t?0:Math.min(t+1,this.options.length-1);else{if("ArrowLeft"!==e.key&&"ArrowUp"!==e.key)return;o=-1===t?0:Math.max(t-1,0)}e.preventDefault();const i=this.options[o].value;i!==this.value&&$e(this,"value-changed",{value:i})}_renderOption(e){const t=this.value===e.value;return W`
      <div
        class="option ${Ae({selected:t})}"
        role="radio"
        aria-checked=${t?"true":"false"}
        aria-label=${op(e.label)}
        title=${op(this.hideOptionLabel?e.label:void 0)}
        .value=${e.value}
    ...
    `}render(){return W`
      <div
        class="container"
        role="radiogroup"
        aria-label=${op(this.label)}
        tabindex=${this.disabled?-1:0}
        @keydown=${this._handleKeydown}
        ?disabled=${this.disabled}
      >
        ${this.options?np(this.options,(e=>e.value),(e=>this._renderOption(e))):J}
      </div>
    `}};ap.styles=h`
    :host {
      display: block;
  ...
  `,n([ve({attribute:!1})],ap.prototype,"options",void 0),n([ve()],ap.prototype,"value",void 0),n([ve({type:Boolean,reflect:!0})],ap.prototype,"vertical",void 0),n([ve({type:Boolean})],ap.prototype,"disabled",void 0),n([ve({attribute:"hide-option-label",type:Boolean})],ap.prototype,"hideOptionLabel",void 0),n([ve()],ap.prototype,"label",void 0),ap=n([ge("cts-ha-control-select")],ap);const sp=(e,t)=>e?t?[...new Set(t)].filter((t=>e.includes(t))):e:[];let lp=class extends _e{static getStubConfig(){return{type:"climate-hvac-modes"}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}get _stateObj(){if(this.hass&&this.context?.entity_id)return this.hass.states[this.context.entity_id]}willUpdate(e){if((e.has("hass")||e.has("context"))&&this._stateObj){const t=e.get("hass");(this.context?.entity_id?t?.states[this.context.entity_id]:void 0)!==this._stateObj&&(this._currentHvacMode=this._stateObj.state)}}_valueChanged(e){const t=e.detail.value,o=this._stateObj;if(!o||!this.hass||t===o.state)return;const i=this._currentHvacMode;this._currentHvacMode=t,this.hass.callService("climate","set_hvac_mode",{entity_id:o.entity_id,hvac_mode:t}).catch((()=>{this._currentHvacMode=i}))}render(){if(!(this._config&&this.hass&&this.context&&this._stateObj&&((e,t)=>{const o=t.entity_id?e.states[t.entity_id]:void 0;return!!o&&o.entity_id.startsWith("climate.")})(this.hass,this.context)))return J;const e=this._stateObj,t=(e.attributes.hvac_modes||[]).concat().sort(st).reverse(),o=sp(t,this._config.hvac_modes).map((t=>({value:t,label:this.hass.formatEntityState(e,t),path:Tc(t).replace("mdi:",""),icon:W`<ha-icon .icon=${Tc(t)}></ha-icon>`})));return W`
      <cts-ha-control-select
        ...
        style=${Me({"--control-select-color":Ec(e)})}
        .disabled=${e.state===Hc}
      ></cts-ha-control-select>
    `}};lp.styles=h`
    :host {
  ...
  `,n([ve({attribute:!1})],lp.prototype,"hass",void 0),n([ve({attribute:!1})],lp.prototype,"context",void 0),n([ve({attribute:!1})],lp.prototype,"color",void 0),n([ye()],lp.prototype,"_config",void 0),n([ye()],lp.prototype,"_currentHvacMode",void 0),lp=n([ge("cts-hui-climate-hvac-modes-card-feature")],lp);let cp=class extends _e{static getStubConfig(){return{type:"climate-preset-modes"}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}get _stateObj(){if(this.hass&&this.context?.entity_id)return this.hass.states[this.context.entity_id]}willUpdate(e){if((e.has("hass")||e.has("context"))&&this._stateObj){const t=e.get("hass");(this.context?.entity_id?t?.states[this.context.entity_id]:void 0)!==this._stateObj&&(this._currentPresetMode=this._stateObj.attributes.preset_mode)}}_valueChanged(e){const t=e.detail.value,o=this._stateObj;if(!o||!this.hass||t===o.attributes.preset_mode)return;const i=this._currentPresetMode;this._currentPresetMode=t,this.hass.callService("climate","set_preset_mode",{entity_id:o.entity_id,preset_mode:t}).catch((()=>{this._currentPresetMode=i}))}render(){if(!(this._config&&this.hass&&this.context&&this._stateObj&&((e,t)=>{const o=t.entity_id?e.states[t.entity_id]:void 0;return!!o&&o.entity_id.startsWith("climate.")&&Se(o,Nc)})(this.hass,this.context)))return J;const e=this._stateObj,t=sp(e.attributes.preset_modes,this._config.preset_modes).map((t=>({value:t,label:this.hass.formatEntityAttributeValue(e,"preset_mode",t),icon:W`<ha-icon .icon=${Tc(t)}></ha-icon>`})));return W`
      <cts-ha-control-select
        .options=${t}
  ...
  `,n([ve({attribute:!1})],cp.prototype,"hass",void 0),n([ve({attribute:!1})],cp.prototype,"context",void 0),n([ve({attribute:!1})],cp.prototype,"color",void 0),n([ye()],cp.prototype,"_config",void 0),n([ye()],cp.prototype,"_currentPresetMode",void 0),cp=n([ge("cts-hui-climate-preset-modes-card-feature")],cp);const up={"climate-hvac-modes":"cts-hui-climate-hvac-modes-card-feature","climate-preset-modes":"cts-hui-climate-preset-modes-card-feature"},dp=e=>{const t=(e=>e?up[e]:void 0)(e?.type);if(t)return document.createElement(t);console.warn(`[better-thermostat-card] feature type "${e?.type}" is not bundled; skipping. Supported: ${Object.keys(up).join(", ")}`)};let hp=class extends _e{_getFeatureElement(e){return this._element||(this._element=dp(e)),this._element}willUpdate(e){if(e.has("feature")&&(this._element=void 0,this.feature)){const e=this._getFeatureElement(this.feature);try{e?.setConfig(this.feature)}catch(e){this._element=void 0}}}render(){if(!this.feature||!this._element)return J;const e=this._element;return e.hass=this.hass,e.context=this.context,e.color=this.color,e.position=this.position,this.context?.entity_id&&this.hass&&(e.stateObj=this.hass.states[this.context.entity_id]),W`${e}`}};hp.styles=h`
    :host {
      display: block;
      pointer-events: auto;
    }
  `,n([ve({attribute:!1})],hp.prototype,"hass",void 0),n([ve({attribute:!1})],hp.prototype,"context",void 0),n([ve({attribute:!1})],hp.prototype,"color",void 0),n([ve({attribute:!1})],hp.prototype,"feature",void 0),n([ve({attribute:!1})],hp.prototype,"position",void 0),hp=n([ge("cts-hui-card-feature")],hp);let pp=class extends _e{render(){return this.features?.length?W`
  ...
  `,n([ve({attribute:!1})],pp.prototype,"hass",void 0),n([ve({attribute:!1})],pp.prototype,"context",void 0),n([ve({attribute:!1})],pp.prototype,"color",void 0),n([ve({attribute:!1})],pp.prototype,"features",void 0),n([ve({attribute:!1})],pp.prototype,"position",void 0),pp=n([ge("cts-hui-card-features")],pp);const _p={auto:"full",cool:"end",dry:"full",fan_only:"full",heat:"start",heat_cool:"full",off:"full"},mp=3e3;hc({type:Zh,name:"Better Thermostat Climate Card",description:"Large climate control card."});let gp=class extends rc{constructor(){super(...arguments),this.preview=!1,this.preventInteractionOnScroll=!1,this._targetTemperature={},this._isDragging=!1,this._lastInteraction=0,this._selectTarget="low",this._presetOverlay=new Eh(this),this._resizeController=new Gh(this,{callback:e=>e[0]?.contentRect.height}),this._sizeController=new Gh(this,{callback:e=>{const t=e[0]?.contentRect.width;return t?t<130?"xs":t<190?"sm":t<250?"md":"lg":"lg"}}),this._debouncedCallService=function(e,t=300){let o;return(...i)=>{o&&clearTimeout(o),o=window.setTimeout((()=>e(...i)),t)}}((e=>this._callService(e)),1e3)}static async getConfigElement(){return await Promise.resolve().then((function(){return Bp})),document.createElement(qh)}static async getStubConfig(e){return{type:`custom:${Zh}`,entity:Gc(e)}}updated(e){super.updated(e);const t=this.shadowRoot?.querySelector(".bt-wrapper");t&&t!==this._observedWrapper&&(this._sizeController.unobserve(this._observedWrapper??this),this._sizeController.observe(t),this._observedWrapper=t);const o=this.shadowRoot?.querySelector("ha-card > .container");o&&o!==this._observedContainer&&(this._resizeController.unobserve(this._observedContainer??this),this._resizeController.observe(o),this._observedContainer=o)}shouldUpdate(e){if(1===e.size&&e.has("hass")){return Ah(e.get("hass"),this.hass,[this._config?.entity,this._config?.window_sensor,this._config?.humidity_sensor,this._config?.preset_entity])}return!0}getCardSize(){return 5}getGridOptions(){let e=5,t=4;if(this._config?.features?.length){const o=Math.ceil(2*this._config.features.length/3);e+=o,t+=o}return{rows:e,columns:12,min_rows:t,min_columns:6}}setConfig(e){if(!e.entity||!["climate"].includes(e.entity.split(".")[0]))throw new Error("Specify an entity from within the climate domain");this._config={disable_buttons:!0,...e}}_handleMoreInfo(){$e(this,"hass-more-info",{entityId:this._config?.entity??null})}willUpdate(e){(e.has("hass")||e.has("_config"))&&this._config?.entity&&(this._stateObj=this.hass.states[this._config.entity],this._stateObj&&(this._featureContext&&this._featureContext.entity_id===this._stateObj.entity_id||(this._featureContext={entity_id:this._stateObj.entity_id}),!this._isDragging&&Date.now()-this._lastInteraction>mp&&(this._targetTemperature={value:this._stateObj.attributes.temperature??void 0,low:this._stateObj.attributes.target_temp_low??void 0,high:this._stateObj.attributes.target_temp_high??void 0})))}get _step(){return this._stateObj?this._stateObj.attributes.target_temp_step||("°F"===this.hass.config.unit_system.temperature?1:.5):1}get _min(){return this._stateObj?.attributes.min_temp??0}get _max(){return this._stateObj?.attributes.max_temp??100}_snap(e){const t=this._min,o=this._max,i=this._step;if(!i||i<=0)return Math.min(Math.max(e,t),o);let n=t+Math.round((e-t)/i)*i;const r=Math.max(i.toString().split(".")?.[1]?.length??0,t.toString().split(".")?.[1]?.length??0,o.toString().split(".")?.[1]?.length??0);return n=parseFloat(n.toFixed(r)),Math.min(Math.max(n,t),o)}_callService(e){this._stateObj&&("high"===e||"low"===e?this.hass.callService("climate","set_temperature",{entity_id:this._stateObj.entity_id,target_temp_low:this._targetTemperature.low,target_temp_high:this._targetTemperature.high}):this.hass.callService("climate","set_temperature",{entity_id:this._stateObj.entity_id,temperature:this._targetTemperature.value}))}_scheduleHoldoffResync(){window.clearTimeout(this._holdoffResyncTimer);const e=Math.max(mp-(Date.now()-this._lastInteraction),0);this._holdoffResyncTimer=window.setTimeout((()=>{if(this._isDragging)return;if(Date.now()-this._lastInteraction<=mp)return void this._scheduleHoldoffResync();const e=this._stateObj?.attributes;e&&(this._targetTemperature={value:e.temperature??void 0,low:e.target_temp_low??void 0,high:e.target_temp_high??void 0})}),e+50)}disconnectedCallback(){window.clearTimeout(this._holdoffResyncTimer),super.disconnectedCallback()}_handleButton(e){this._lastInteraction=Date.now();const t=e.currentTarget,o=t.target,i=t.step,n="high"===o?this._max:this._min;let r=this._targetTemperature[o]??n;r+=i,r=this._snap(r),"high"===o&&null!=this._targetTemperature.low&&(r=Math.max(r,this._snap(this._targetTemperature.low))),"low"===o&&null!=this._targetTemperature.high&&(r=Math.min(r,this._snap(this._targetTemperature.high))),this._targetTemperature={...this._targetTemperature,[o]:r},this._debouncedCallService(o),this._scheduleHoldoffResync()}_handleSelect(e){const t=e.currentTarget;this._selectTarget=t.target}_valueChanged(e){const t=e.detail.value;if(isNaN(t))return;this._isDragging=!1,this._lastInteraction=Date.now();const o=this._snap(t);this._targetTemperature={...this._targetTemperature,value:o},this._callService("value"),this._scheduleHoldoffResync()}_valueChanging(e){const t=e.detail.value;isNaN(t)||(this._isDragging=!0,this._targetTemperature={...this._targetTemperature,value:t})}_lowChanged(e){const t=e.detail.value;if(isNaN(t))return;this._isDragging=!1,this._lastInteraction=Date.now();const o=this._snap(t);this._targetTemperature={...this._targetTemperature,low:o},this._callService("low"),this._scheduleHoldoffResync()}_lowChanging(e){const t=e.detail.value;isNaN(t)||(this._isDragging=!0,this._targetTemperature={...this._targetTemperature,low:t})}_highChanged(e){const t=e.detail.value;if(isNaN(t))return;this._isDragging=!1,this._lastInteraction=Date.now();const o=this._snap(t);this._targetTemperature={...this._targetTemperature,high:o},this._callService("high"),this._scheduleHoldoffResync()}_highChanging(e){const t=e.detail.value;isNaN(t)||(this._isDragging=!0,this._targetTemperature={...this._targetTemperature,high:t})}get _supportsTargetValue(){return null!=this._stateObj&&Se(this._stateObj,Ic)&&null!=this._targetTemperature.value}get _supportsTargetRange(){return null!=this._stateObj&&Se(this._stateObj,Bc)&&null!=this._targetTemperature.low&&null!=this._targetTemperature.high}render(){if(!this._config||!this._stateObj)return J;const e=this._stateObj,t=xh(this.hass);this.preventInteractionOnScroll=Boolean(this._config.prevent_interaction_on_scroll);const o=Zc(this.hass,e,this._config),i=null!=e.attributes.current_temperature&&(this._config.show_current_as_primary||!this._supportsTargetValue&&!this._supportsTargetRange),n=e.attributes.hvac_action,r=tp(e),a=this._sizeController.value?` ${this._sizeController.value}`:"";let s;n&&"idle"!==n&&"off"!==n&&r&&(s=zc(fc[n]??"off"));let l=Ec(e);const c=this._config.preset_entity,u=Dc(this.hass,e,c);if(o)s="var(--info-color)",l="var(--info-color)";else if(null!=u&&(!c||xc(u))){const e=zc(u);l=e,s=e}const d=!1===e.attributes.call_for_heat;"off"===e.state&&(d&&!o?(l="var(--bt-color-summer)",s="var(--bt-color-summer)"):o||(l="var(--bt-color-grey)",s="var(--bt-color-grey)"));const h=zc(r?"heat":"off"),p=zc(r?"cool":"off"),_=this._resizeController.value?`${Math.min(this._resizeController.value,320)}px`:void 0,m=this._config.name||e.attributes.friendly_name||"";return W`
      <ha-card style=${Me(Cc(this._config.colors))}>
        <p class="title">${m}</p>
        <div class="container">
          <div
            class="bt-wrapper container${a}"
            style=${Me({"--low-color":h,"--high-color":p,"--state-color":l??"var(--primary-text-color)","--action-color":s??"",maxWidth:_})}
          >
    ...
    `}_renderCircularSlider(e){const t=this._stateObj;let o=_p[t.state||"off"]||"full";return"full"===o&&["off","auto"].includes(t.state)&&!t.attributes.hvac_modes?.includes("heat_cool")&&(t.attributes.hvac_modes?.includes("heat")?o="start":t.attributes.hvac_modes?.includes("cool")&&(o="end")),this._supportsTargetRange?W`
        <ha-control-circular-slider
    ...
    `}_renderTarget(e,t=!1,o=!1){const i=this._step.toString().split(".")?.[1]?.length??0,n={maximumFractionDigits:i,minimumFractionDigits:i},r=o?"":this.hass.config.unit_system.temperature,a=Ne(e,this.hass.locale,n);return t?W`
      ...
      ${o}
    `}_renderLabel(e){const t=this._stateObj,o=Yc(t,this._config),i=Jc(t,this._config),n=Qc(t,this._config),r=W`
      ${n?W`
            <span
            ...
            >
              <ha-svg-icon .path=${Xh}></ha-svg-icon>
            </span>
          `:J}
      ${i?W`
            <span
      ...
      ${o?W`
          ...
          `:J}
    `,a=!1===t.attributes.call_for_heat;return t.state===Hc?W`<div class="label-container">
        ${r}
      ...
      <p class="label hvac_action">${this.hass.formatEntityState(t)}</p>
    </div>`}_renderPrimary(e){const t=this._stateObj;return t.state===Hc?J:e?this._renderCurrent(t.attributes.current_temperature,!0):this._supportsTargetValue?this._renderTarget(this._targetTemperature.value,!0):this._supportsTargetRange?W`<div class="dual">
        <button
        ...
        <ha-svg-icon .path=${Yh}></ha-svg-icon>${this._renderTarget(this._targetTemperature.value)}
      ...
      </p>`}_renderHumidity(){const e=qc(this.hass,this._stateObj,this._config);return e?W`
    ...
    `:J}_renderButtons(e){const t=this._stateObj.state===Hc;return W`<div class="buttons">
    ...
    `}_renderPresetButton(e,t){const o=this._stateObj,i=e===t?zc(e):"var(--bt-color-grey)",n={"--icon-color":i,"--bg-color":bc(i,.2)},r=Vc(this.hass,o,e,this._config?.preset_entity);return W`
      <mushroom-button
        style=${Me(n)}
        .mode=${e}
        .disabled=${!ht(o)}
    ...
    `}renderModeButton(e){if(!this._stateObj?.attributes)return J;if("presets"===e){const e=this._config?.preset_entity,t=Dc(this.hass,this._stateObj,e),o={},i=t??"none",n=zc(i);null!=t&&(o["--icon-color"]=n,o["--bg-color"]=bc(n,.2));const r=null!=t?jc(t):Tc("none"),a=Lc(this.hass,this._stateObj,e),s=null!=t?Vc(this.hass,this._stateObj,t,e):wh({hass:this.hass,string:"extra_states.presets"});if(1===a.length){const t=Vc(this.hass,this._stateObj,a[0],e);return W`
          <mushroom-button
            style=${Me(o)}
            .mode=${i}
            title=${t}
    ...
    `}triggerModeChange(e){this._stateObj&&Rc(this.hass,this._stateObj,e,this._config?.preset_entity)&&this._presetOverlay.setOpen(!1)}_openMoreInfo(e,t){e.stopPropagation(),e.preventDefault(),t&&$e(this,"hass-more-info",{entityId:t})}static get styles(){return[super.styles,Mh,Mc,Ch,$h,Qh]}};n([ve({type:Boolean})],gp.prototype,"preview",void 0),n([ve({attribute:!1})],gp.prototype,"hass",void 0),n([ve({type:Boolean,attribute:"prevent-interaction-on-scroll"})],gp.prototype,"preventInteractionOnScroll",void 0),n([ye()],gp.prototype,"_config",void 0),n([ye()],gp.prototype,"_stateObj",void 0),n([ye()],gp.prototype,"_featureContext",void 0),n([ye()],gp.prototype,"_targetTemperature",void 0),n([ye()],gp.prototype,"_selectTarget",void 0),gp=n([ge(Zh)],gp),console.info("%cBetter Thermostat UI - 3.2.2","color: #ef5350; font-weight: 700;");let bp=class extends _e{constructor(){super(...arguments),this.title="",this.disabled=!1}render(){return W`
      <button
        type="button"
        class="button"
        .title=${this.title}
    ...
    `}};n([ve()],bp.prototype,"title",void 0),n([ve({type:Boolean})],bp.prototype,"disabled",void 0),bp=n([ge("mushroom-button")],bp);var fp=Object.freeze({__proto__:null,get Button(){return bp}});let vp=class extends _e{constructor(){super(...arguments),this.fill=!1,this.rtl=!1}render(){return W`
      <div
    ...
    `}};n([ve()],vp.prototype,"fill",void 0),n([ve()],vp.prototype,"rtl",void 0),vp=n([ge("mushroom-button-group")],vp);var yp=Object.freeze({__proto__:null,get MushroomButtonGroup(){return vp}});let wp=class extends _e{constructor(){super(...arguments),this.disabled=!1,this.formatOptions={},this.pending=!1,this.dispatchValue=e=>{this.pending=!1,this.dispatchEvent(new CustomEvent("change",{detail:{value:e}}))},this.debounceDispatchValue=this.dispatchValue}get _precision(){return Math.ceil(Math.log10(1/this._step))}get _step(){return this.step??1}_incrementValue(e){if(e.stopPropagation(),null==this.value)return;const t=Be(this.value+this._step,this._precision);this._processNewValue(t)}_decrementValue(e){if(e.stopPropagation(),null==this.value)return;const t=Be(this.value-this._step,this._precision);this._processNewValue(t)}firstUpdated(e){super.firstUpdated(e);const t=(e=>{const t=window.getComputedStyle(e).getPropertyValue("--input-number-debounce"),o=parseFloat(t);return isNaN(o)?2e3:o})(this.container);t&&(this.debounceDispatchValue=((e,t,o=!1)=>{let i;const n=(...n)=>{const r=o&&!i;clearTimeout(i),i=window.setTimeout((()=>{i=void 0,o||e(...n)}),t),r&&e(...n)};return n.cancel=()=>{clearTimeout(i)},n})(this.dispatchValue,t))}_processNewValue(e){const t=((e,t,o)=>{let i;return i=t?Math.max(e,t):e,i=o?Math.min(i,o):i,i})(e,this.min,this.max);this.value!==t&&(this.value=t,this.pending=!0),this.debounceDispatchValue(t)}render(){const e=null!=this.value?Ne(this.value,this.locale,this.formatOptions):"-";return W`
    ...
    `}};n([ve({attribute:!1})],wp.prototype,"locale",void 0),n([ve({type:Boolean})],wp.prototype,"disabled",void 0),n([ve({attribute:!1,type:Number,reflect:!0})],wp.prototype,"value",void 0),n([ve({type:Number})],wp.prototype,"step",void 0),n([ve({type:Number})],wp.prototype,"min",void 0),n([ve({type:Number})],wp.prototype,"max",void 0),n([ve({attribute:!1})],wp.prototype,"formatOptions",void 0),n([ye()],wp.prototype,"pending",void 0),n([
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(e,t){return(t,o,i)=>((e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,o),o))(t,o,{get(){return(t=>t.renderRoot?.querySelector(e)??null)(this)}})}("#container")],wp.prototype,"container",void 0),wp=n([ge("mushroom-input-number")],wp);var kp=Object.freeze({__proto__:null,get InputNumber(){return wp}});et({tap_action:tt(Ct),hold_action:tt(Ct),double_tap_action:tt(Ct)});et({layout:tt(nt([Qe("horizontal"),Qe("vertical"),Qe("default")])),fill_container:tt(Ye()),primary_info:tt(Je(sc)),secondary_info:tt(Je(sc)),icon_type:tt(Je(["icon","entity-picture","none"]))});const zp=[{type:"grid",name:"",schema:[{name:"layout",selector:{mush_layout:{}}},{name:"fill_container",selector:{boolean:{}}}]},{type:"grid",name:"",schema:[{name:"primary_info",selector:{mush_info:{}}},{name:"secondary_info",selector:{mush_info:{}}},{name:"icon_type",selector:{mush_icon_type:{}}}]}],xp=["color","icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation","picture"],Ap=()=>{customElements.get("ha-form")&&customElements.get("hui-card-features-editor")||customElements.get("hui-tile-card")?.getConfigElement(),customElements.get("ha-entity-picker")||customElements.get("hui-entities-card")?.getConfigElement(),customElements.get("ha-card-conditions-editor")||customElements.get("hui-conditional-card")?.getConfigElement()},Ep=["show_temperature_control","collapsible_controls","show_current_as_primary","show_secondary","disable_buttons","disable_all_buttons","disable_menu","prevent_interaction_on_scroll","disable_eco","disable_humidity","disable_presets","show_all_presets","disable_battery_warning","disable_connection_lost_warning","disable_degraded_warning","debug_battery","debug_connection","debug_degraded","low_battery_threshold","window_sensor","humidity_sensor","preset_entity","section_display","section_interaction","section_features","section_warnings","section_sensors"],Cp=()=>({name:"section_sensors",type:"expandable",flatten:!0,expanded:!0,iconPath:Jh,schema:[{name:"window_sensor",selector:{entity:{domain:["binary_sensor","input_boolean"]}}},{name:"humidity_sensor",selector:{entity:{domain:["sensor"],device_class:"humidity"}}},{name:"preset_entity",selector:{entity:{domain:["select","input_select"]}}}]}),Mp=e=>({name:"section_display",type:"expandable",flatten:!0,expanded:!0,iconPath:"M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z",schema:[{type:"grid",name:"",schema:e.map((e=>({...e,selector:{boolean:{}}})))}]}),$p=mt(((e,t)=>{const o=(void 0===e?[...vc]:vc.filter((t=>e.split(",").includes(t)))).filter((e=>"off"!==e)),i=void 0===t?[...yc]:yc.filter((e=>t.split(",").map((e=>e.toLowerCase())).includes(e)));return{name:"colors",type:"expandable",iconPath:"M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z",schema:[{type:"grid",name:"",schema:[...o,...i].map((e=>({name:e,selector:{ui_color:{}}})))}]}})),Sp=(e,t,o,i)=>{if(wc.includes(o))return t?vc.includes(o)?e.formatEntityState(t,o):e.formatEntityAttributeValue(t,"preset_mode",o):e.localize(`component.climate.entity_component._.state.${o}`)||e.localize(`component.climate.entity_component._.state_attributes.preset_mode.state.${o}`)||i(`editor.card.climate.${o}`)||o},Tp=e=>({name:"section_warnings",type:"expandable",flatten:!0,iconPath:Xh,schema:[{type:"grid",name:"",schema:[{name:"disable_battery_warning",selector:{boolean:{}}},{name:"disable_connection_lost_warning",selector:{boolean:{}}},{name:"disable_degraded_warning",selector:{boolean:{}}},{name:"debug_battery",selector:{boolean:{}}},{name:"debug_connection",selector:{boolean:{}}},{name:"debug_degraded",selector:{boolean:{}}}]},{name:"low_battery_threshold",default:10,selector:{number:{min:0,max:100,step:1,mode:"box",unit_of_measurement:"%"}}}]}),jp=mt(((e,t,o)=>{return[{name:"entity",selector:{entity:{domain:mc}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},...zp,...e?[]:[Cp()],Mp([{name:"show_temperature_control"},{name:"collapsible_controls"}]),$p(t,o),{name:"section_interaction",type:"expandable",flatten:!0,iconPath:"M10,9A1,1 0 0,1 11,8A1,1 0 0,1 12,9V13.47L13.21,13.6L18.15,15.79C18.68,16.03 19,16.56 19,17.14V21.5C18.97,22.32 18.32,22.97 17.5,23H11C10.62,23 10.26,22.85 10,22.57L5.1,18.37L5.84,17.6C6.03,17.39 6.3,17.28 6.58,17.28H6.8L10,19V9M11,5A4,4 0 0,1 15,9C15,10.5 14.2,11.77 13,12.46V11.24C13.61,10.69 14,9.89 14,9A3,3 0 0,0 11,6A3,3 0 0,0 8,9C8,9.89 8.39,10.69 9,11.24V12.46C7.8,11.77 7,10.5 7,9A4,4 0 0,1 11,5Z",schema:[{type:"grid",name:"",schema:[{name:"disable_buttons",selector:{boolean:{}}},{name:"disable_all_buttons",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"prevent_interaction_on_scroll",selector:{boolean:{}}}]}]},{name:"section_features",type:"expandable",flatten:!0,iconPath:"M3,17V19H9V17H3M3,5V7H13V5H3M13,21V19H21V17H13V15H11V21H13M7,9V11H3V13H7V15H9V9H7M21,13V11H11V13H21M15,9H17V7H21V5H17V3H15V9Z",schema:[{type:"grid",name:"",schema:[{name:"disable_eco",selector:{boolean:{}}},{name:"disable_humidity",selector:{boolean:{}}},{name:"disable_presets",selector:{boolean:{}}},{name:"show_all_presets",selector:{boolean:{}}}]}]},...e?[Tp()]:[],{name:"tap_action",selector:{ui_action:{actions:i}}},{name:"hold_action",selector:{ui_action:{actions:i}}},{name:"double_tap_action",selector:{ui_action:{actions:i}}}];var i}));let Pp=class extends rc{constructor(){super(...arguments),this._computeLabel=e=>{const t=xh(this.hass);if("colors"===e.name)return t("editor.card.climate.section_colors");const o=Sp(this.hass,this._stateObj,e.name,t);return void 0!==o?o:xp.includes(e.name)?t(`editor.card.generic.${e.name}`):Ep.includes(e.name)?t(`editor.card.climate.${e.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)},this._computeHelper=e=>"colors"===e.name?xh(this.hass)("editor.card.climate.section_colors_helper"):void 0}static get styles(){const e=super.styles;return[...Array.isArray(e)?e:[e],h`
        :host {
          display: block;
          padding-bottom: 16px;
        }
      ...
      `]}connectedCallback(){super.connectedCallback(),Ap()}setConfig(e){this._config=e}get _stateObj(){return this._config?.entity?this.hass?.states[this._config.entity]:void 0}render(){if(!this.hass||!this._config)return J;const e=this._stateObj,t=!!e&&Fc(e),o=!e&&!!this._config.entity,i=this._config.preset_entity?this.hass.states[this._config.preset_entity]:void 0,n=i?(i.attributes.options??[]).join(","):e?(e.attributes.preset_modes??[]).join(","):void 0,r=jp(t,e?(e.attributes.hvac_modes??[]).join(","):void 0,n);return W`
      ${o?W`
      ...
      ${e&&!t?W`
            <ha-alert alert-type="info">
              ${xh(this.hass)("editor.card.climate.not_bt_info")}
            </ha-alert>
          `:J}
      <ha-form
        .hass=${this.hass}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}_valueChanged(e){const t={...e.detail.value};if(t.colors){const e=Object.fromEntries(Object.entries(t.colors).filter((([,e])=>e)));0===Object.keys(e).length?delete t.colors:t.colors=e}$e(this,"config-changed",{config:t})}};n([ye()],Pp.prototype,"_config",void 0),Pp=n([ge(_c)],Pp);var Hp=Object.freeze({__proto__:null,get ClimateCardEditor(){return Pp}});const Op=mt(((e,t,o)=>[{name:"entity",selector:{entity:{domain:Wh}}},{name:"name",selector:{text:{}}},...e?[]:[Cp()],Mp([{name:"show_current_as_primary"},{name:"show_secondary"}]),$p(t,o),{name:"section_interaction",type:"expandable",flatten:!0,iconPath:"M10,9A1,1 0 0,1 11,8A1,1 0 0,1 12,9V13.47L13.21,13.6L18.15,15.79C18.68,16.03 19,16.56 19,17.14V21.5C18.97,22.32 18.32,22.97 17.5,23H11C10.62,23 10.26,22.85 10,22.57L5.1,18.37L5.84,17.6C6.03,17.39 6.3,17.28 6.58,17.28H6.8L10,19V9M11,5A4,4 0 0,1 15,9C15,10.5 14.2,11.77 13,12.46V11.24C13.61,10.69 14,9.89 14,9A3,3 0 0,0 11,6A3,3 0 0,0 8,9C8,9.89 8.39,10.69 9,11.24V12.46C7.8,11.77 7,10.5 7,9A4,4 0 0,1 11,5Z",schema:[{type:"grid",name:"",schema:[{name:"disable_buttons",selector:{boolean:{}}},{name:"disable_all_buttons",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"prevent_interaction_on_scroll",selector:{boolean:{}}}]}]},{name:"section_features",type:"expandable",flatten:!0,iconPath:"M3,17V19H9V17H3M3,5V7H13V5H3M13,21V19H21V17H13V15H11V21H13M7,9V11H3V13H7V15H9V9H7M21,13V11H11V13H21M15,9H17V7H21V5H17V3H15V9Z",schema:[{type:"grid",name:"",schema:[{name:"disable_eco",selector:{boolean:{}}},{name:"disable_humidity",selector:{boolean:{}}},{name:"disable_presets",selector:{boolean:{}}},{name:"show_all_presets",selector:{boolean:{}}}]}]},...e?[Tp()]:[]]));let Ip=class extends rc{static get styles(){const e=super.styles;return[...Array.isArray(e)?e:e?[e]:[],h`
        :host {
          display: block;
          padding-bottom: 16px;
        }
      ...
      `]}connectedCallback(){super.connectedCallback(),Ap()}setConfig(e){this._config=e}render(){if(!this.hass)return W``;const e=xh(this.hass),t=this._config?.entity?this.hass.states[this._config.entity]:void 0,o=!t||Fc(t),i=this._config?.preset_entity?this.hass.states[this._config.preset_entity]:void 0,n=i?(i.attributes.options??[]).join(","):t?(t.attributes.preset_modes??[]).join(","):void 0,r=Op(o,t?(t.attributes.hvac_modes??[]).join(","):void 0,n);return W`
      ${o?"":W`
            <ha-alert alert-type="info">
      ...
      <ha-form
        ...
        .schema=${r}
        .computeLabel=${o=>{if("entity"===o.name)return e("ui.panel.lovelace.editor.card.generic.entity")||o.name;if("colors"===o.name)return e("editor.card.climate.section_colors")||o.name;const i=Sp(this.hass,t,o.name,e);return void 0!==i?i:xp.includes(o.name)?e(`editor.card.generic.${o.name}`)||o.name:e(`editor.card.climate.${o.name}`)||o.name}}
        .computeHelper=${t=>"colors"===t.name?e("editor.card.climate.section_colors_helper"):void 0}
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}_valueChanged(e){e.stopPropagation();const t={...e.detail.value};if(t.colors){const e=Object.fromEntries(Object.entries(t.colors).filter((([,e])=>e)));0===Object.keys(e).length?delete t.colors:t.colors=e}this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}};n([ye()],Ip.prototype,"_config",void 0),Ip=n([ge(qh)],Ip);var Bp=Object.freeze({__proto__:null,get NormalClimateCardEditor(){return Ip}});
